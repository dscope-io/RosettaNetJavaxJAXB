...
public class ProductLineItemType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerDescriptionType lhsRequestedShipFrom;
            lhsRequestedShipFrom = this.getRequestedShipFrom();
            SpecifiedPartnerDescriptionType rhsRequestedShipFrom;
            rhsRequestedShipFrom = that.getRequestedShipFrom();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "requestedShipFrom", lhsRequestedShipFrom), LocatorUtils.property(thatLocator, "requestedShipFrom", rhsRequestedShipFrom), lhsRequestedShipFrom, rhsRequestedShipFrom, (this.requestedShipFrom!= null), (that.requestedShipFrom!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerDescriptionType theRequestedShipFrom;
            theRequestedShipFrom = this.getRequestedShipFrom();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "requestedShipFrom", theRequestedShipFrom), currentHashCode, theRequestedShipFrom, (this.requestedShipFrom!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            SpecifiedPartnerDescriptionType theRequestedShipFrom;
            theRequestedShipFrom = this.getRequestedShipFrom();
            strategy.appendField(locator, this, "requestedShipFrom", buffer, theRequestedShipFrom, (this.requestedShipFrom!= null));
        }
        {
            List<ProductPricingType> theRequestedUnitPrice;
            theRequestedUnitPrice = (((this.requestedUnitPrice!= null)&&(!this.requestedUnitPrice.isEmpty()))?this.getRequestedUnitPrice():null);
