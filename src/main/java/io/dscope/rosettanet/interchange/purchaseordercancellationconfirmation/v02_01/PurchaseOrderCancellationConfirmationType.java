...
public class PurchaseOrderCancellationConfirmationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderCancellationConfirmationType that = ((PurchaseOrderCancellationConfirmationType) object);
        {
        ...
        {
            PurchaseOrderCancellationType lhsPurchaseOrderCancellation;
            lhsPurchaseOrderCancellation = this.getPurchaseOrderCancellation();
            PurchaseOrderCancellationType rhsPurchaseOrderCancellation;
            rhsPurchaseOrderCancellation = that.getPurchaseOrderCancellation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "purchaseOrderCancellation", lhsPurchaseOrderCancellation), LocatorUtils.property(thatLocator, "purchaseOrderCancellation", rhsPurchaseOrderCancellation), lhsPurchaseOrderCancellation, rhsPurchaseOrderCancellation, (this.purchaseOrderCancellation!= null), (that.purchaseOrderCancellation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderCancellationType thePurchaseOrderCancellation;
            thePurchaseOrderCancellation = this.getPurchaseOrderCancellation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "purchaseOrderCancellation", thePurchaseOrderCancellation), currentHashCode, thePurchaseOrderCancellation, (this.purchaseOrderCancellation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            PurchaseOrderCancellationType thePurchaseOrderCancellation;
            thePurchaseOrderCancellation = this.getPurchaseOrderCancellation();
            strategy.appendField(locator, this, "purchaseOrderCancellation", buffer, thePurchaseOrderCancellation, (this.purchaseOrderCancellation!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
