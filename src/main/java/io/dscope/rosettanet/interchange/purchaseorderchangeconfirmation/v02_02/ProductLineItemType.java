...
public class ProductLineItemType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DeliveryInformationType lhsShippedQuantityInformation;
            lhsShippedQuantityInformation = this.getShippedQuantityInformation();
            DeliveryInformationType rhsShippedQuantityInformation;
            rhsShippedQuantityInformation = that.getShippedQuantityInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "shippedQuantityInformation", lhsShippedQuantityInformation), LocatorUtils.property(thatLocator, "shippedQuantityInformation", rhsShippedQuantityInformation), lhsShippedQuantityInformation, rhsShippedQuantityInformation, (this.shippedQuantityInformation!= null), (that.shippedQuantityInformation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DeliveryInformationType theShippedQuantityInformation;
            theShippedQuantityInformation = this.getShippedQuantityInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "shippedQuantityInformation", theShippedQuantityInformation), currentHashCode, theShippedQuantityInformation, (this.shippedQuantityInformation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            DeliveryInformationType theShippedQuantityInformation;
            theShippedQuantityInformation = this.getShippedQuantityInformation();
            strategy.appendField(locator, this, "shippedQuantityInformation", buffer, theShippedQuantityInformation, (this.shippedQuantityInformation!= null));
        }
        {
            SpecifiedPartnerDescriptionType theShipTo;
            theShipTo = this.getShipTo();
