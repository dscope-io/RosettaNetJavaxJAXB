...
public class WarrantyClaimRequestType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WarrantyClaimRequestType that = ((WarrantyClaimRequestType) object);
        {
        ...
        {
            WarrantyClaimRequestDataType lhsWarrantyClaimRequestData;
            lhsWarrantyClaimRequestData = this.getWarrantyClaimRequestData();
            WarrantyClaimRequestDataType rhsWarrantyClaimRequestData;
            rhsWarrantyClaimRequestData = that.getWarrantyClaimRequestData();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "warrantyClaimRequestData", lhsWarrantyClaimRequestData), LocatorUtils.property(thatLocator, "warrantyClaimRequestData", rhsWarrantyClaimRequestData), lhsWarrantyClaimRequestData, rhsWarrantyClaimRequestData, (this.warrantyClaimRequestData!= null), (that.warrantyClaimRequestData!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WarrantyClaimRequestDataType theWarrantyClaimRequestData;
            theWarrantyClaimRequestData = this.getWarrantyClaimRequestData();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "warrantyClaimRequestData", theWarrantyClaimRequestData), currentHashCode, theWarrantyClaimRequestData, (this.warrantyClaimRequestData!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            WarrantyClaimRequestDataType theWarrantyClaimRequestData;
            theWarrantyClaimRequestData = this.getWarrantyClaimRequestData();
            strategy.appendField(locator, this, "warrantyClaimRequestData", buffer, theWarrantyClaimRequestData, (this.warrantyClaimRequestData!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
