...
public class CertificateOfAnalysisNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CertificateOfAnalysisNotificationType that = ((CertificateOfAnalysisNotificationType) object);
        {
            List<CertificateOfAnalysisType> lhsCertificateOfAnalysis;
            lhsCertificateOfAnalysis = (((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty()))?this.getCertificateOfAnalysis():null);
            List<CertificateOfAnalysisType> rhsCertificateOfAnalysis;
            rhsCertificateOfAnalysis = (((that.certificateOfAnalysis!= null)&&(!that.certificateOfAnalysis.isEmpty()))?that.getCertificateOfAnalysis():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "certificateOfAnalysis", lhsCertificateOfAnalysis), LocatorUtils.property(thatLocator, "certificateOfAnalysis", rhsCertificateOfAnalysis), lhsCertificateOfAnalysis, rhsCertificateOfAnalysis, ((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty())), ((that.certificateOfAnalysis!= null)&&(!that.certificateOfAnalysis.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<CertificateOfAnalysisType> theCertificateOfAnalysis;
            theCertificateOfAnalysis = (((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty()))?this.getCertificateOfAnalysis():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "certificateOfAnalysis", theCertificateOfAnalysis), currentHashCode, theCertificateOfAnalysis, ((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<CertificateOfAnalysisType> theCertificateOfAnalysis;
            theCertificateOfAnalysis = (((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty()))?this.getCertificateOfAnalysis():null);
            strategy.appendField(locator, this, "certificateOfAnalysis", buffer, theCertificateOfAnalysis, ((this.certificateOfAnalysis!= null)&&(!this.certificateOfAnalysis.isEmpty())));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
