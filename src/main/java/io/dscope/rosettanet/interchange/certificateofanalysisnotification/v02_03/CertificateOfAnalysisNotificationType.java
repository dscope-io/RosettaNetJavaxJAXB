...
public class CertificateOfAnalysisNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CertificateOfAnalysisType lhsCertificateOfAnalysis;
            lhsCertificateOfAnalysis = this.getCertificateOfAnalysis();
            CertificateOfAnalysisType rhsCertificateOfAnalysis;
            rhsCertificateOfAnalysis = that.getCertificateOfAnalysis();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "certificateOfAnalysis", lhsCertificateOfAnalysis), LocatorUtils.property(thatLocator, "certificateOfAnalysis", rhsCertificateOfAnalysis), lhsCertificateOfAnalysis, rhsCertificateOfAnalysis, (this.certificateOfAnalysis!= null), (that.certificateOfAnalysis!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CertificateOfAnalysisType theCertificateOfAnalysis;
            theCertificateOfAnalysis = this.getCertificateOfAnalysis();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "certificateOfAnalysis", theCertificateOfAnalysis), currentHashCode, theCertificateOfAnalysis, (this.certificateOfAnalysis!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            CertificateOfAnalysisType theCertificateOfAnalysis;
            theCertificateOfAnalysis = this.getCertificateOfAnalysis();
            strategy.appendField(locator, this, "certificateOfAnalysis", buffer, theCertificateOfAnalysis, (this.certificateOfAnalysis!= null));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
