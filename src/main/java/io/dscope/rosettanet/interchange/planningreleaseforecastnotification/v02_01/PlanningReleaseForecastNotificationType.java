...
public class PlanningReleaseForecastNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PlanningReleaseForecastNotificationType that = ((PlanningReleaseForecastNotificationType) object);
        {
        ...
        {
            PlanningReleaseForecastType lhsPlanningReleaseForecast;
            lhsPlanningReleaseForecast = this.getPlanningReleaseForecast();
            PlanningReleaseForecastType rhsPlanningReleaseForecast;
            rhsPlanningReleaseForecast = that.getPlanningReleaseForecast();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "planningReleaseForecast", lhsPlanningReleaseForecast), LocatorUtils.property(thatLocator, "planningReleaseForecast", rhsPlanningReleaseForecast), lhsPlanningReleaseForecast, rhsPlanningReleaseForecast, (this.planningReleaseForecast!= null), (that.planningReleaseForecast!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PlanningReleaseForecastType thePlanningReleaseForecast;
            thePlanningReleaseForecast = this.getPlanningReleaseForecast();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "planningReleaseForecast", thePlanningReleaseForecast), currentHashCode, thePlanningReleaseForecast, (this.planningReleaseForecast!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            PlanningReleaseForecastType thePlanningReleaseForecast;
            thePlanningReleaseForecast = this.getPlanningReleaseForecast();
            strategy.appendField(locator, this, "planningReleaseForecast", buffer, thePlanningReleaseForecast, (this.planningReleaseForecast!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
