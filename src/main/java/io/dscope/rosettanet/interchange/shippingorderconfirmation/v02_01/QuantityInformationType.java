...
public class QuantityInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            Float lhsConfirmedQuantity;
            lhsConfirmedQuantity = this.getConfirmedQuantity();
            Float rhsConfirmedQuantity;
            rhsConfirmedQuantity = that.getConfirmedQuantity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "confirmedQuantity", lhsConfirmedQuantity), LocatorUtils.property(thatLocator, "confirmedQuantity", rhsConfirmedQuantity), lhsConfirmedQuantity, rhsConfirmedQuantity, (this.confirmedQuantity!= null), (that.confirmedQuantity!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            Float theConfirmedQuantity;
            theConfirmedQuantity = this.getConfirmedQuantity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "confirmedQuantity", theConfirmedQuantity), currentHashCode, theConfirmedQuantity, (this.confirmedQuantity!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            Float theConfirmedQuantity;
            theConfirmedQuantity = this.getConfirmedQuantity();
            strategy.appendField(locator, this, "confirmedQuantity", buffer, theConfirmedQuantity, (this.confirmedQuantity!= null));
        }
        {
            Float theRequestedQuantity;
            theRequestedQuantity = this.getRequestedQuantity();
