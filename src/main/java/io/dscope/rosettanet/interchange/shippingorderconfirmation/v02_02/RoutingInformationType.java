...
public class RoutingInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsDeliveryPriorityIdenfier;
            lhsDeliveryPriorityIdenfier = this.getDeliveryPriorityIdenfier();
            String rhsDeliveryPriorityIdenfier;
            rhsDeliveryPriorityIdenfier = that.getDeliveryPriorityIdenfier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "deliveryPriorityIdenfier", lhsDeliveryPriorityIdenfier), LocatorUtils.property(thatLocator, "deliveryPriorityIdenfier", rhsDeliveryPriorityIdenfier), lhsDeliveryPriorityIdenfier, rhsDeliveryPriorityIdenfier, (this.deliveryPriorityIdenfier!= null), (that.deliveryPriorityIdenfier!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theDeliveryPriorityIdenfier;
            theDeliveryPriorityIdenfier = this.getDeliveryPriorityIdenfier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "deliveryPriorityIdenfier", theDeliveryPriorityIdenfier), currentHashCode, theDeliveryPriorityIdenfier, (this.deliveryPriorityIdenfier!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theDeliveryPriorityIdenfier;
            theDeliveryPriorityIdenfier = this.getDeliveryPriorityIdenfier();
            strategy.appendField(locator, this, "deliveryPriorityIdenfier", buffer, theDeliveryPriorityIdenfier, (this.deliveryPriorityIdenfier!= null));
        }
        {
            FreightPaymentInformation theFreightPaymentInformation;
            theFreightPaymentInformation = this.getFreightPaymentInformation();
