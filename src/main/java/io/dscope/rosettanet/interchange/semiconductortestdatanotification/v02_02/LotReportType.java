...
public class LotReportType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsPartnerSecurityID;
            lhsPartnerSecurityID = this.getPartnerSecurityID();
            String rhsPartnerSecurityID;
            rhsPartnerSecurityID = that.getPartnerSecurityID();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "partnerSecurityID", lhsPartnerSecurityID), LocatorUtils.property(thatLocator, "partnerSecurityID", rhsPartnerSecurityID), lhsPartnerSecurityID, rhsPartnerSecurityID, (this.partnerSecurityID!= null), (that.partnerSecurityID!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String thePartnerSecurityID;
            thePartnerSecurityID = this.getPartnerSecurityID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "partnerSecurityID", thePartnerSecurityID), currentHashCode, thePartnerSecurityID, (this.partnerSecurityID!= null));
        }
        {
            List<Pin> thePin;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String thePartnerSecurityID;
            thePartnerSecurityID = this.getPartnerSecurityID();
            strategy.appendField(locator, this, "partnerSecurityID", buffer, thePartnerSecurityID, (this.partnerSecurityID!= null));
        }
        {
            List<Pin> thePin;
            thePin = (((this.pin!= null)&&(!this.pin.isEmpty()))?this.getPin():null);
