...
public class SetupReportType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<ChipPeriodicity> lhsChipPeriodicity;
            lhsChipPeriodicity = (((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty()))?this.getChipPeriodicity():null);
            List<ChipPeriodicity> rhsChipPeriodicity;
            rhsChipPeriodicity = (((that.chipPeriodicity!= null)&&(!that.chipPeriodicity.isEmpty()))?that.getChipPeriodicity():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "chipPeriodicity", lhsChipPeriodicity), LocatorUtils.property(thatLocator, "chipPeriodicity", rhsChipPeriodicity), lhsChipPeriodicity, rhsChipPeriodicity, ((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty())), ((that.chipPeriodicity!= null)&&(!that.chipPeriodicity.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<ChipPeriodicity> theChipPeriodicity;
            theChipPeriodicity = (((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty()))?this.getChipPeriodicity():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "chipPeriodicity", theChipPeriodicity), currentHashCode, theChipPeriodicity, ((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty())));
        }
        {
        ...
        {
            List<SoftwareReport> theSoftwareReport;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<ChipPeriodicity> theChipPeriodicity;
            theChipPeriodicity = (((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty()))?this.getChipPeriodicity():null);
            strategy.appendField(locator, this, "chipPeriodicity", buffer, theChipPeriodicity, ((this.chipPeriodicity!= null)&&(!this.chipPeriodicity.isEmpty())));
        }
        {
            CoordinateFlag theCoordinateFlag;
            theCoordinateFlag = this.getCoordinateFlag();
