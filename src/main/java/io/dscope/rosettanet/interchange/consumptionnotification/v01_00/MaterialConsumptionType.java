...
public class MaterialConsumptionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MaterialConsumptionType that = ((MaterialConsumptionType) object);
        {
            List<MaterialType> lhsMaterial;
            lhsMaterial = (((this.material!= null)&&(!this.material.isEmpty()))?this.getMaterial():null);
            List<MaterialType> rhsMaterial;
