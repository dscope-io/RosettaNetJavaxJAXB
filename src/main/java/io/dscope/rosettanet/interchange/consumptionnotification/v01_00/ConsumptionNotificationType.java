...
public class ConsumptionNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConsumptionNotificationType that = ((ConsumptionNotificationType) object);
        {
            ConsumptionNoticeType lhsConsumptionNotice;
            lhsConsumptionNotice = this.getConsumptionNotice();
            ConsumptionNoticeType rhsConsumptionNotice;
            rhsConsumptionNotice = that.getConsumptionNotice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "consumptionNotice", lhsConsumptionNotice), LocatorUtils.property(thatLocator, "consumptionNotice", rhsConsumptionNotice), lhsConsumptionNotice, rhsConsumptionNotice, (this.consumptionNotice!= null), (that.consumptionNotice!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ConsumptionNoticeType theConsumptionNotice;
            theConsumptionNotice = this.getConsumptionNotice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "consumptionNotice", theConsumptionNotice), currentHashCode, theConsumptionNotice, (this.consumptionNotice!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ConsumptionNoticeType theConsumptionNotice;
            theConsumptionNotice = this.getConsumptionNotice();
            strategy.appendField(locator, this, "consumptionNotice", buffer, theConsumptionNotice, (this.consumptionNotice!= null));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
