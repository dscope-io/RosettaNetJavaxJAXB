...
public class ConsumptionNoticeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConsumptionNoticeType that = ((ConsumptionNoticeType) object);
        {
        ...
        {
            List<MaterialConsumptionType> lhsMaterialConsumption;
            lhsMaterialConsumption = (((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty()))?this.getMaterialConsumption():null);
            List<MaterialConsumptionType> rhsMaterialConsumption;
            rhsMaterialConsumption = (((that.materialConsumption!= null)&&(!that.materialConsumption.isEmpty()))?that.getMaterialConsumption():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "materialConsumption", lhsMaterialConsumption), LocatorUtils.property(thatLocator, "materialConsumption", rhsMaterialConsumption), lhsMaterialConsumption, rhsMaterialConsumption, ((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty())), ((that.materialConsumption!= null)&&(!that.materialConsumption.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<MaterialConsumptionType> theMaterialConsumption;
            theMaterialConsumption = (((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty()))?this.getMaterialConsumption():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "materialConsumption", theMaterialConsumption), currentHashCode, theMaterialConsumption, ((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<MaterialConsumptionType> theMaterialConsumption;
            theMaterialConsumption = (((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty()))?this.getMaterialConsumption():null);
            strategy.appendField(locator, this, "materialConsumption", buffer, theMaterialConsumption, ((this.materialConsumption!= null)&&(!this.materialConsumption.isEmpty())));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
