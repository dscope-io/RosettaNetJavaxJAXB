...
public class RequestingOrderInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            OrderAdmin lhsOrderAdmin;
            lhsOrderAdmin = this.getOrderAdmin();
            OrderAdmin rhsOrderAdmin;
            rhsOrderAdmin = that.getOrderAdmin();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "orderAdmin", lhsOrderAdmin), LocatorUtils.property(thatLocator, "orderAdmin", rhsOrderAdmin), lhsOrderAdmin, rhsOrderAdmin, (this.orderAdmin!= null), (that.orderAdmin!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            OrderAdmin theOrderAdmin;
            theOrderAdmin = this.getOrderAdmin();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "orderAdmin", theOrderAdmin), currentHashCode, theOrderAdmin, (this.orderAdmin!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            OrderAdmin theOrderAdmin;
            theOrderAdmin = this.getOrderAdmin();
            strategy.appendField(locator, this, "orderAdmin", buffer, theOrderAdmin, (this.orderAdmin!= null));
        }
        {
            BusinessDocumentReferenceType theOrderReference;
            theOrderReference = this.getOrderReference();
