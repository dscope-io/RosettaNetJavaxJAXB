...
public class ProductInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductInformationType that = ((ProductInformationType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "authorizedQuantity", lhsAuthorizedQuantity), LocatorUtils.property(thatLocator, "authorizedQuantity", rhsAuthorizedQuantity), lhsAuthorizedQuantity, rhsAuthorizedQuantity, true, true)) {
                return false;
            }
        }
        {
            float lhsAvailableAuthorizedQuantity;
            lhsAvailableAuthorizedQuantity = this.getAvailableAuthorizedQuantity();
            float rhsAvailableAuthorizedQuantity;
            rhsAvailableAuthorizedQuantity = that.getAvailableAuthorizedQuantity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "availableAuthorizedQuantity", lhsAvailableAuthorizedQuantity), LocatorUtils.property(thatLocator, "availableAuthorizedQuantity", rhsAvailableAuthorizedQuantity), lhsAvailableAuthorizedQuantity, rhsAvailableAuthorizedQuantity, true, true)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "authorizedQuantity", theAuthorizedQuantity), currentHashCode, theAuthorizedQuantity, true);
        }
        {
            float theAvailableAuthorizedQuantity;
            theAvailableAuthorizedQuantity = this.getAvailableAuthorizedQuantity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "availableAuthorizedQuantity", theAvailableAuthorizedQuantity), currentHashCode, theAvailableAuthorizedQuantity, true);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            float theAuthorizedQuantity;
            theAuthorizedQuantity = this.getAuthorizedQuantity();
            strategy.appendField(locator, this, "authorizedQuantity", buffer, theAuthorizedQuantity, true);
        }
        {
            float theAvailableAuthorizedQuantity;
            theAvailableAuthorizedQuantity = this.getAvailableAuthorizedQuantity();
            strategy.appendField(locator, this, "availableAuthorizedQuantity", buffer, theAvailableAuthorizedQuantity, true);
        }
        {
            List<BusinessDocumentReference> theBusinessDocumentReference;
            theBusinessDocumentReference = (((this.businessDocumentReference!= null)&&(!this.businessDocumentReference.isEmpty()))?this.getBusinessDocumentReference():null);
