...
public class EmbeddedReleaseForecastType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EmbeddedReleaseForecastType that = ((EmbeddedReleaseForecastType) object);
        {
            TransportEventType lhsEmbeddedReleaseForecastTransportEvent;
            lhsEmbeddedReleaseForecastTransportEvent = this.getEmbeddedReleaseForecastTransportEvent();
            TransportEventType rhsEmbeddedReleaseForecastTransportEvent;
            rhsEmbeddedReleaseForecastTransportEvent = that.getEmbeddedReleaseForecastTransportEvent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "embeddedReleaseForecastTransportEvent", lhsEmbeddedReleaseForecastTransportEvent), LocatorUtils.property(thatLocator, "embeddedReleaseForecastTransportEvent", rhsEmbeddedReleaseForecastTransportEvent), lhsEmbeddedReleaseForecastTransportEvent, rhsEmbeddedReleaseForecastTransportEvent, (this.embeddedReleaseForecastTransportEvent!= null), (that.embeddedReleaseForecastTransportEvent!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TransportEventType theEmbeddedReleaseForecastTransportEvent;
            theEmbeddedReleaseForecastTransportEvent = this.getEmbeddedReleaseForecastTransportEvent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "embeddedReleaseForecastTransportEvent", theEmbeddedReleaseForecastTransportEvent), currentHashCode, theEmbeddedReleaseForecastTransportEvent, (this.embeddedReleaseForecastTransportEvent!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            TransportEventType theEmbeddedReleaseForecastTransportEvent;
            theEmbeddedReleaseForecastTransportEvent = this.getEmbeddedReleaseForecastTransportEvent();
            strategy.appendField(locator, this, "embeddedReleaseForecastTransportEvent", buffer, theEmbeddedReleaseForecastTransportEvent, (this.embeddedReleaseForecastTransportEvent!= null));
        }
        {
            ForecastEvent theForecastEvent;
            theForecastEvent = this.getForecastEvent();
