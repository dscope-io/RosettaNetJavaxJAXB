...
public class SalesReportNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SalesReportNotificationType that = ((SalesReportNotificationType) object);
        {
        ...
        {
            SalesReportType lhsSalesReport;
            lhsSalesReport = this.getSalesReport();
            SalesReportType rhsSalesReport;
            rhsSalesReport = that.getSalesReport();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "salesReport", lhsSalesReport), LocatorUtils.property(thatLocator, "salesReport", rhsSalesReport), lhsSalesReport, rhsSalesReport, (this.salesReport!= null), (that.salesReport!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SalesReportType theSalesReport;
            theSalesReport = this.getSalesReport();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "salesReport", theSalesReport), currentHashCode, theSalesReport, (this.salesReport!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            SalesReportType theSalesReport;
            theSalesReport = this.getSalesReport();
            strategy.appendField(locator, this, "salesReport", buffer, theSalesReport, (this.salesReport!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
