...
public class RemittanceAdviceNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RemittanceAdviceNotificationType that = ((RemittanceAdviceNotificationType) object);
        {
        ...
        {
            RemittanceAdviceType lhsRemittanceAdvice;
            lhsRemittanceAdvice = this.getRemittanceAdvice();
            RemittanceAdviceType rhsRemittanceAdvice;
            rhsRemittanceAdvice = that.getRemittanceAdvice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "remittanceAdvice", lhsRemittanceAdvice), LocatorUtils.property(thatLocator, "remittanceAdvice", rhsRemittanceAdvice), lhsRemittanceAdvice, rhsRemittanceAdvice, (this.remittanceAdvice!= null), (that.remittanceAdvice!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RemittanceAdviceType theRemittanceAdvice;
            theRemittanceAdvice = this.getRemittanceAdvice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "remittanceAdvice", theRemittanceAdvice), currentHashCode, theRemittanceAdvice, (this.remittanceAdvice!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            RemittanceAdviceType theRemittanceAdvice;
            theRemittanceAdvice = this.getRemittanceAdvice();
            strategy.appendField(locator, this, "remittanceAdvice", buffer, theRemittanceAdvice, (this.remittanceAdvice!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
