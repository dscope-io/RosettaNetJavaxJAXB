...
public class ShippingContainerItemType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            RequestingOrderLineItemReference lhsRequestingOrderLineItemReference;
            lhsRequestingOrderLineItemReference = this.getRequestingOrderLineItemReference();
            RequestingOrderLineItemReference rhsRequestingOrderLineItemReference;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RequestingOrderLineItemReference theRequestingOrderLineItemReference;
