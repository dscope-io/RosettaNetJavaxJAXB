...
public class ShippingBusinessDocumentType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsDeclarationStatus;
            lhsDeclarationStatus = this.getDeclarationStatus();
            String rhsDeclarationStatus;
            rhsDeclarationStatus = that.getDeclarationStatus();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "declarationStatus", lhsDeclarationStatus), LocatorUtils.property(thatLocator, "declarationStatus", rhsDeclarationStatus), lhsDeclarationStatus, rhsDeclarationStatus, (this.declarationStatus!= null), (that.declarationStatus!= null))) {
                return false;
            }
        }
        {
        ...
        {
            BigInteger lhsTotalPackages;
            lhsTotalPackages = this.getTotalPackages();
            BigInteger rhsTotalPackages;
            rhsTotalPackages = that.getTotalPackages();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "totalPackages", lhsTotalPackages), LocatorUtils.property(thatLocator, "totalPackages", rhsTotalPackages), lhsTotalPackages, rhsTotalPackages, (this.totalPackages!= null), (that.totalPackages!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theDeclarationStatus;
            theDeclarationStatus = this.getDeclarationStatus();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "declarationStatus", theDeclarationStatus), currentHashCode, theDeclarationStatus, (this.declarationStatus!= null));
        }
        {
        ...
        {
            BigInteger theTotalPackages;
            theTotalPackages = this.getTotalPackages();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "totalPackages", theTotalPackages), currentHashCode, theTotalPackages, (this.totalPackages!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theDeclarationStatus;
            theDeclarationStatus = this.getDeclarationStatus();
            strategy.appendField(locator, this, "declarationStatus", buffer, theDeclarationStatus, (this.declarationStatus!= null));
        }
        {
            HeaderInformationType theHeaderInformation;
            theHeaderInformation = this.getHeaderInformation();
        ...
        }
        {
            BigInteger theTotalPackages;
            theTotalPackages = this.getTotalPackages();
            strategy.appendField(locator, this, "totalPackages", buffer, theTotalPackages, (this.totalPackages!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
