...
public class ShipmentLineItemType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsCustomsValuationMethod;
            lhsCustomsValuationMethod = this.getCustomsValuationMethod();
            String rhsCustomsValuationMethod;
            rhsCustomsValuationMethod = that.getCustomsValuationMethod();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customsValuationMethod", lhsCustomsValuationMethod), LocatorUtils.property(thatLocator, "customsValuationMethod", rhsCustomsValuationMethod), lhsCustomsValuationMethod, rhsCustomsValuationMethod, (this.customsValuationMethod!= null), (that.customsValuationMethod!= null))) {
                return false;
            }
        }
        {
        ...
        {
            List<BusinessDocumentReferenceType> lhsPreviousBusinessDocumentReference;
            lhsPreviousBusinessDocumentReference = (((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty()))?this.getPreviousBusinessDocumentReference():null);
            List<BusinessDocumentReferenceType> rhsPreviousBusinessDocumentReference;
            rhsPreviousBusinessDocumentReference = (((that.previousBusinessDocumentReference!= null)&&(!that.previousBusinessDocumentReference.isEmpty()))?that.getPreviousBusinessDocumentReference():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "previousBusinessDocumentReference", lhsPreviousBusinessDocumentReference), LocatorUtils.property(thatLocator, "previousBusinessDocumentReference", rhsPreviousBusinessDocumentReference), lhsPreviousBusinessDocumentReference, rhsPreviousBusinessDocumentReference, ((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty())), ((that.previousBusinessDocumentReference!= null)&&(!that.previousBusinessDocumentReference.isEmpty())))) {
                return false;
            }
        }
        {
            List<String> lhsPreviousCustomsProcedure;
            lhsPreviousCustomsProcedure = (((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty()))?this.getPreviousCustomsProcedure():null);
            List<String> rhsPreviousCustomsProcedure;
            rhsPreviousCustomsProcedure = (((that.previousCustomsProcedure!= null)&&(!that.previousCustomsProcedure.isEmpty()))?that.getPreviousCustomsProcedure():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "previousCustomsProcedure", lhsPreviousCustomsProcedure), LocatorUtils.property(thatLocator, "previousCustomsProcedure", rhsPreviousCustomsProcedure), lhsPreviousCustomsProcedure, rhsPreviousCustomsProcedure, ((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty())), ((that.previousCustomsProcedure!= null)&&(!that.previousCustomsProcedure.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theCustomsValuationMethod;
            theCustomsValuationMethod = this.getCustomsValuationMethod();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customsValuationMethod", theCustomsValuationMethod), currentHashCode, theCustomsValuationMethod, (this.customsValuationMethod!= null));
        }
        {
        ...
        {
            List<BusinessDocumentReferenceType> thePreviousBusinessDocumentReference;
            thePreviousBusinessDocumentReference = (((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty()))?this.getPreviousBusinessDocumentReference():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "previousBusinessDocumentReference", thePreviousBusinessDocumentReference), currentHashCode, thePreviousBusinessDocumentReference, ((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty())));
        }
        {
            List<String> thePreviousCustomsProcedure;
            thePreviousCustomsProcedure = (((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty()))?this.getPreviousCustomsProcedure():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "previousCustomsProcedure", thePreviousCustomsProcedure), currentHashCode, thePreviousCustomsProcedure, ((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theCustomsValuationMethod;
            theCustomsValuationMethod = this.getCustomsValuationMethod();
            strategy.appendField(locator, this, "customsValuationMethod", buffer, theCustomsValuationMethod, (this.customsValuationMethod!= null));
        }
        {
            ExportLicense theExportLicense;
            theExportLicense = this.getExportLicense();
        ...
        }
        {
            List<BusinessDocumentReferenceType> thePreviousBusinessDocumentReference;
            thePreviousBusinessDocumentReference = (((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty()))?this.getPreviousBusinessDocumentReference():null);
            strategy.appendField(locator, this, "previousBusinessDocumentReference", buffer, thePreviousBusinessDocumentReference, ((this.previousBusinessDocumentReference!= null)&&(!this.previousBusinessDocumentReference.isEmpty())));
        }
        {
            List<String> thePreviousCustomsProcedure;
            thePreviousCustomsProcedure = (((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty()))?this.getPreviousCustomsProcedure():null);
            strategy.appendField(locator, this, "previousCustomsProcedure", buffer, thePreviousCustomsProcedure, ((this.previousCustomsProcedure!= null)&&(!this.previousCustomsProcedure.isEmpty())));
        }
        {
            PricingInformationType thePricingInformation;
            thePricingInformation = this.getPricingInformation();
