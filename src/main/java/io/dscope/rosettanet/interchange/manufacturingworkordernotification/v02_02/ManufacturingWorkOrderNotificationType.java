...
public class ManufacturingWorkOrderNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ManufacturingWorkOrderNotificationType that = ((ManufacturingWorkOrderNotificationType) object);
        {
        ...
        {
            WorkOrderType lhsWorkOrder;
            lhsWorkOrder = this.getWorkOrder();
            WorkOrderType rhsWorkOrder;
            rhsWorkOrder = that.getWorkOrder();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "workOrder", lhsWorkOrder), LocatorUtils.property(thatLocator, "workOrder", rhsWorkOrder), lhsWorkOrder, rhsWorkOrder, (this.workOrder!= null), (that.workOrder!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WorkOrderType theWorkOrder;
            theWorkOrder = this.getWorkOrder();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "workOrder", theWorkOrder), currentHashCode, theWorkOrder, (this.workOrder!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            WorkOrderType theWorkOrder;
            theWorkOrder = this.getWorkOrder();
            strategy.appendField(locator, this, "workOrder", buffer, theWorkOrder, (this.workOrder!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
