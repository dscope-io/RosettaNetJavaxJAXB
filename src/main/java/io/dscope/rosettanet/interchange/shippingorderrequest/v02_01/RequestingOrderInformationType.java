...
public class RequestingOrderInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "isOrderToBeMerged", lhsIsOrderToBeMerged), LocatorUtils.property(thatLocator, "isOrderToBeMerged", rhsIsOrderToBeMerged), lhsIsOrderToBeMerged, rhsIsOrderToBeMerged, (this.isOrderToBeMerged!= null), (that.isOrderToBeMerged!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "isOrderToBeMerged", theIsOrderToBeMerged), currentHashCode, theIsOrderToBeMerged, (this.isOrderToBeMerged!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            Boolean theIsOrderToBeMerged;
            theIsOrderToBeMerged = this.isIsOrderToBeMerged();
            strategy.appendField(locator, this, "isOrderToBeMerged", buffer, theIsOrderToBeMerged, (this.isOrderToBeMerged!= null));
        }
        {
            List<OrderAdmin> theOrderAdmin;
            theOrderAdmin = (((this.orderAdmin!= null)&&(!this.orderAdmin.isEmpty()))?this.getOrderAdmin():null);
