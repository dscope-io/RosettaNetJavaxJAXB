...
public class ProductPriceAndAvailabilityType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            boolean lhsIsAdditionalInformationAllowed;
            lhsIsAdditionalInformationAllowed = this.isIsAdditionalInformationAllowed();
            boolean rhsIsAdditionalInformationAllowed;
            rhsIsAdditionalInformationAllowed = that.isIsAdditionalInformationAllowed();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "isAdditionalInformationAllowed", lhsIsAdditionalInformationAllowed), LocatorUtils.property(thatLocator, "isAdditionalInformationAllowed", rhsIsAdditionalInformationAllowed), lhsIsAdditionalInformationAllowed, rhsIsAdditionalInformationAllowed, true, true)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            boolean theIsAdditionalInformationAllowed;
            theIsAdditionalInformationAllowed = this.isIsAdditionalInformationAllowed();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "isAdditionalInformationAllowed", theIsAdditionalInformationAllowed), currentHashCode, theIsAdditionalInformationAllowed, true);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            boolean theIsAdditionalInformationAllowed;
            theIsAdditionalInformationAllowed = this.isIsAdditionalInformationAllowed();
            strategy.appendField(locator, this, "isAdditionalInformationAllowed", buffer, theIsAdditionalInformationAllowed, true);
        }
        {
            PriceCondition thePriceCondition;
            thePriceCondition = this.getPriceCondition();
