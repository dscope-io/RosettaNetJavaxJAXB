...
public class ProductScheduleType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            StrategicForecastQuantityType lhsStrategicForecastQuantityType;
            lhsStrategicForecastQuantityType = this.getStrategicForecastQuantityType();
            StrategicForecastQuantityType rhsStrategicForecastQuantityType;
            rhsStrategicForecastQuantityType = that.getStrategicForecastQuantityType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "strategicForecastQuantityType", lhsStrategicForecastQuantityType), LocatorUtils.property(thatLocator, "strategicForecastQuantityType", rhsStrategicForecastQuantityType), lhsStrategicForecastQuantityType, rhsStrategicForecastQuantityType, (this.strategicForecastQuantityType!= null), (that.strategicForecastQuantityType!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            StrategicForecastQuantityType theStrategicForecastQuantityType;
            theStrategicForecastQuantityType = this.getStrategicForecastQuantityType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "strategicForecastQuantityType", theStrategicForecastQuantityType), currentHashCode, theStrategicForecastQuantityType, (this.strategicForecastQuantityType!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            StrategicForecastQuantityType theStrategicForecastQuantityType;
            theStrategicForecastQuantityType = this.getStrategicForecastQuantityType();
            strategy.appendField(locator, this, "strategicForecastQuantityType", buffer, theStrategicForecastQuantityType, (this.strategicForecastQuantityType!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
