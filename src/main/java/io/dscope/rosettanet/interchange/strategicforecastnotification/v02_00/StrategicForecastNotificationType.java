...
public class StrategicForecastNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final StrategicForecastNotificationType that = ((StrategicForecastNotificationType) object);
        {
        ...
        {
            StrategicForecastType lhsStrategicForecast;
            lhsStrategicForecast = this.getStrategicForecast();
            StrategicForecastType rhsStrategicForecast;
            rhsStrategicForecast = that.getStrategicForecast();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "strategicForecast", lhsStrategicForecast), LocatorUtils.property(thatLocator, "strategicForecast", rhsStrategicForecast), lhsStrategicForecast, rhsStrategicForecast, (this.strategicForecast!= null), (that.strategicForecast!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            StrategicForecastType theStrategicForecast;
            theStrategicForecast = this.getStrategicForecast();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "strategicForecast", theStrategicForecast), currentHashCode, theStrategicForecast, (this.strategicForecast!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            StrategicForecastType theStrategicForecast;
            theStrategicForecast = this.getStrategicForecast();
            strategy.appendField(locator, this, "strategicForecast", buffer, theStrategicForecast, (this.strategicForecast!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
