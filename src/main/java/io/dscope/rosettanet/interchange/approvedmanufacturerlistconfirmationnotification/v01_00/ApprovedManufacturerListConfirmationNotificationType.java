...
public class ApprovedManufacturerListConfirmationNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ApprovedManufacturerListConfirmationNotificationType that = ((ApprovedManufacturerListConfirmationNotificationType) object);
        {
            ApprovedManufacturerListType lhsApprovedManufacturerList;
            lhsApprovedManufacturerList = this.getApprovedManufacturerList();
            ApprovedManufacturerListType rhsApprovedManufacturerList;
            rhsApprovedManufacturerList = that.getApprovedManufacturerList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "approvedManufacturerList", lhsApprovedManufacturerList), LocatorUtils.property(thatLocator, "approvedManufacturerList", rhsApprovedManufacturerList), lhsApprovedManufacturerList, rhsApprovedManufacturerList, (this.approvedManufacturerList!= null), (that.approvedManufacturerList!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ApprovedManufacturerListType theApprovedManufacturerList;
            theApprovedManufacturerList = this.getApprovedManufacturerList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "approvedManufacturerList", theApprovedManufacturerList), currentHashCode, theApprovedManufacturerList, (this.approvedManufacturerList!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ApprovedManufacturerListType theApprovedManufacturerList;
            theApprovedManufacturerList = this.getApprovedManufacturerList();
            strategy.appendField(locator, this, "approvedManufacturerList", buffer, theApprovedManufacturerList, (this.approvedManufacturerList!= null));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
