...
public class CarrierReportType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<CarrierSlotType> lhsCarrierSlot;
            lhsCarrierSlot = (((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty()))?this.getCarrierSlot():null);
            List<CarrierSlotType> rhsCarrierSlot;
            rhsCarrierSlot = (((that.carrierSlot!= null)&&(!that.carrierSlot.isEmpty()))?that.getCarrierSlot():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "carrierSlot", lhsCarrierSlot), LocatorUtils.property(thatLocator, "carrierSlot", rhsCarrierSlot), lhsCarrierSlot, rhsCarrierSlot, ((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty())), ((that.carrierSlot!= null)&&(!that.carrierSlot.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<CarrierSlotType> theCarrierSlot;
            theCarrierSlot = (((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty()))?this.getCarrierSlot():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "carrierSlot", theCarrierSlot), currentHashCode, theCarrierSlot, ((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<CarrierSlotType> theCarrierSlot;
            theCarrierSlot = (((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty()))?this.getCarrierSlot():null);
            strategy.appendField(locator, this, "carrierSlot", buffer, theCarrierSlot, ((this.carrierSlot!= null)&&(!this.carrierSlot.isEmpty())));
        }
        {
            String theCarrierType;
            theCarrierType = this.getCarrierType();
