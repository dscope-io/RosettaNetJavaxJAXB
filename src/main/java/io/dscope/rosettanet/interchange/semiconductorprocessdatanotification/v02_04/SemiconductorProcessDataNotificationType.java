...
public class SemiconductorProcessDataNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SemiconductorProcessDataNotificationType that = ((SemiconductorProcessDataNotificationType) object);
        {
        ...
        {
            LotReportType lhsLotReport;
            lhsLotReport = this.getLotReport();
            LotReportType rhsLotReport;
            rhsLotReport = that.getLotReport();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lotReport", lhsLotReport), LocatorUtils.property(thatLocator, "lotReport", rhsLotReport), lhsLotReport, rhsLotReport, (this.lotReport!= null), (that.lotReport!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LotReportType theLotReport;
            theLotReport = this.getLotReport();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lotReport", theLotReport), currentHashCode, theLotReport, (this.lotReport!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            LotReportType theLotReport;
            theLotReport = this.getLotReport();
            strategy.appendField(locator, this, "lotReport", buffer, theLotReport, (this.lotReport!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
