...
public class DesignRegistrationConfirmationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DesignRegistrationConfirmationType that = ((DesignRegistrationConfirmationType) object);
        {
            DesignRegistrationInformationType lhsDesignRegistrationInformation;
            lhsDesignRegistrationInformation = this.getDesignRegistrationInformation();
            DesignRegistrationInformationType rhsDesignRegistrationInformation;
            rhsDesignRegistrationInformation = that.getDesignRegistrationInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "designRegistrationInformation", lhsDesignRegistrationInformation), LocatorUtils.property(thatLocator, "designRegistrationInformation", rhsDesignRegistrationInformation), lhsDesignRegistrationInformation, rhsDesignRegistrationInformation, (this.designRegistrationInformation!= null), (that.designRegistrationInformation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DesignRegistrationInformationType theDesignRegistrationInformation;
            theDesignRegistrationInformation = this.getDesignRegistrationInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "designRegistrationInformation", theDesignRegistrationInformation), currentHashCode, theDesignRegistrationInformation, (this.designRegistrationInformation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            DesignRegistrationInformationType theDesignRegistrationInformation;
            theDesignRegistrationInformation = this.getDesignRegistrationInformation();
            strategy.appendField(locator, this, "designRegistrationInformation", buffer, theDesignRegistrationInformation, (this.designRegistrationInformation!= null));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
