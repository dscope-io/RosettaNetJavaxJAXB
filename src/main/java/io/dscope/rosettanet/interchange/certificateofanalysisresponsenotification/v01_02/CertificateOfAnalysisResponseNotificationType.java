...
public class CertificateOfAnalysisResponseNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CertificateOfAnalysisResponseType lhsCertificateOfAnalysisResponse;
            lhsCertificateOfAnalysisResponse = this.getCertificateOfAnalysisResponse();
            CertificateOfAnalysisResponseType rhsCertificateOfAnalysisResponse;
            rhsCertificateOfAnalysisResponse = that.getCertificateOfAnalysisResponse();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "certificateOfAnalysisResponse", lhsCertificateOfAnalysisResponse), LocatorUtils.property(thatLocator, "certificateOfAnalysisResponse", rhsCertificateOfAnalysisResponse), lhsCertificateOfAnalysisResponse, rhsCertificateOfAnalysisResponse, (this.certificateOfAnalysisResponse!= null), (that.certificateOfAnalysisResponse!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CertificateOfAnalysisResponseType theCertificateOfAnalysisResponse;
            theCertificateOfAnalysisResponse = this.getCertificateOfAnalysisResponse();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "certificateOfAnalysisResponse", theCertificateOfAnalysisResponse), currentHashCode, theCertificateOfAnalysisResponse, (this.certificateOfAnalysisResponse!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            CertificateOfAnalysisResponseType theCertificateOfAnalysisResponse;
            theCertificateOfAnalysisResponse = this.getCertificateOfAnalysisResponse();
            strategy.appendField(locator, this, "certificateOfAnalysisResponse", buffer, theCertificateOfAnalysisResponse, (this.certificateOfAnalysisResponse!= null));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
