...
public class IntraCompanyTransferType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IntraCompanyTransferType that = ((IntraCompanyTransferType) object);
        {
            float lhsInTransitQuantity;
            lhsInTransitQuantity = this.getInTransitQuantity();
            float rhsInTransitQuantity;
            rhsInTransitQuantity = that.getInTransitQuantity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "inTransitQuantity", lhsInTransitQuantity), LocatorUtils.property(thatLocator, "inTransitQuantity", rhsInTransitQuantity), lhsInTransitQuantity, rhsInTransitQuantity, true, true)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            float theInTransitQuantity;
            theInTransitQuantity = this.getInTransitQuantity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "inTransitQuantity", theInTransitQuantity), currentHashCode, theInTransitQuantity, true);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            float theInTransitQuantity;
            theInTransitQuantity = this.getInTransitQuantity();
            strategy.appendField(locator, this, "inTransitQuantity", buffer, theInTransitQuantity, true);
        }
        {
            List<PartnerDescription> thePartnerDescription;
            thePartnerDescription = (((this.partnerDescription!= null)&&(!this.partnerDescription.isEmpty()))?this.getPartnerDescription():null);
