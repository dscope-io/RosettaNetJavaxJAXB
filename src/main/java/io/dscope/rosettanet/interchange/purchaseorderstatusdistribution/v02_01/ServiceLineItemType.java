...
public class ServiceLineItemType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ProductPricingType lhsOrderPricing;
            lhsOrderPricing = this.getOrderPricing();
            ProductPricingType rhsOrderPricing;
            rhsOrderPricing = that.getOrderPricing();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "orderPricing", lhsOrderPricing), LocatorUtils.property(thatLocator, "orderPricing", rhsOrderPricing), lhsOrderPricing, rhsOrderPricing, (this.orderPricing!= null), (that.orderPricing!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductPricingType theOrderPricing;
            theOrderPricing = this.getOrderPricing();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "orderPricing", theOrderPricing), currentHashCode, theOrderPricing, (this.orderPricing!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ProductPricingType theOrderPricing;
            theOrderPricing = this.getOrderPricing();
            strategy.appendField(locator, this, "orderPricing", buffer, theOrderPricing, (this.orderPricing!= null));
        }
        {
            PartnerDescription thePartnerDescription;
            thePartnerDescription = this.getPartnerDescription();
