...
public class PreviousLotType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PreviousLotType that = ((PreviousLotType) object);
        {
        ...
        {
            LotQuantity lhsLotQuantity;
            lhsLotQuantity = this.getLotQuantity();
            LotQuantity rhsLotQuantity;
            rhsLotQuantity = that.getLotQuantity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lotQuantity", lhsLotQuantity), LocatorUtils.property(thatLocator, "lotQuantity", rhsLotQuantity), lhsLotQuantity, rhsLotQuantity, (this.lotQuantity!= null), (that.lotQuantity!= null))) {
                return false;
            }
        }
        {
            LotTypeType lhsPreviousLotType;
            lhsPreviousLotType = this.getPreviousLotType();
            LotTypeType rhsPreviousLotType;
            rhsPreviousLotType = that.getPreviousLotType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "previousLotType", lhsPreviousLotType), LocatorUtils.property(thatLocator, "previousLotType", rhsPreviousLotType), lhsPreviousLotType, rhsPreviousLotType, (this.previousLotType!= null), (that.previousLotType!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LotQuantity theLotQuantity;
            theLotQuantity = this.getLotQuantity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lotQuantity", theLotQuantity), currentHashCode, theLotQuantity, (this.lotQuantity!= null));
        }
        {
            LotTypeType thePreviousLotType;
            thePreviousLotType = this.getPreviousLotType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "previousLotType", thePreviousLotType), currentHashCode, thePreviousLotType, (this.previousLotType!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            LotQuantity theLotQuantity;
            theLotQuantity = this.getLotQuantity();
            strategy.appendField(locator, this, "lotQuantity", buffer, theLotQuantity, (this.lotQuantity!= null));
        }
        {
            LotTypeType thePreviousLotType;
            thePreviousLotType = this.getPreviousLotType();
            strategy.appendField(locator, this, "previousLotType", buffer, thePreviousLotType, (this.previousLotType!= null));
        }
        {
            ProductIdentification theProductIdentification;
            theProductIdentification = this.getProductIdentification();
