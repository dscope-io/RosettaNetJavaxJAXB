...
public class WorkInProcessDistributionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WorkInProcessDistributionType that = ((WorkInProcessDistributionType) object);
        {
        ...
        {
            WorkInProcessType lhsWorkInProcess;
            lhsWorkInProcess = this.getWorkInProcess();
            WorkInProcessType rhsWorkInProcess;
            rhsWorkInProcess = that.getWorkInProcess();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "workInProcess", lhsWorkInProcess), LocatorUtils.property(thatLocator, "workInProcess", rhsWorkInProcess), lhsWorkInProcess, rhsWorkInProcess, (this.workInProcess!= null), (that.workInProcess!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WorkInProcessType theWorkInProcess;
            theWorkInProcess = this.getWorkInProcess();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "workInProcess", theWorkInProcess), currentHashCode, theWorkInProcess, (this.workInProcess!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            WorkInProcessType theWorkInProcess;
            theWorkInProcess = this.getWorkInProcess();
            strategy.appendField(locator, this, "workInProcess", buffer, theWorkInProcess, (this.workInProcess!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
