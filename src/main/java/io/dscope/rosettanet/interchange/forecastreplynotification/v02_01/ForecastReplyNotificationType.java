...
public class ForecastReplyNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ForecastReplyNotificationType that = ((ForecastReplyNotificationType) object);
        {
        ...
        {
            ForecastReplyType lhsForecastReply;
            lhsForecastReply = this.getForecastReply();
            ForecastReplyType rhsForecastReply;
            rhsForecastReply = that.getForecastReply();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "forecastReply", lhsForecastReply), LocatorUtils.property(thatLocator, "forecastReply", rhsForecastReply), lhsForecastReply, rhsForecastReply, (this.forecastReply!= null), (that.forecastReply!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ForecastReplyType theForecastReply;
            theForecastReply = this.getForecastReply();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "forecastReply", theForecastReply), currentHashCode, theForecastReply, (this.forecastReply!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ForecastReplyType theForecastReply;
            theForecastReply = this.getForecastReply();
            strategy.appendField(locator, this, "forecastReply", buffer, theForecastReply, (this.forecastReply!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
