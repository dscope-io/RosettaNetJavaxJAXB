...
public class ShippingOrderCancellationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShippingOrderCancellationType that = ((ShippingOrderCancellationType) object);
        {
            SpecifiedPartnerDescriptionType lhsCancelBy;
            lhsCancelBy = this.getCancelBy();
            SpecifiedPartnerDescriptionType rhsCancelBy;
            rhsCancelBy = that.getCancelBy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cancelBy", lhsCancelBy), LocatorUtils.property(thatLocator, "cancelBy", rhsCancelBy), lhsCancelBy, rhsCancelBy, (this.cancelBy!= null), (that.cancelBy!= null))) {
                return false;
            }
        }
        {
            CancellationConfirmationType lhsCancellationConfirmation;
            lhsCancellationConfirmation = this.getCancellationConfirmation();
            CancellationConfirmationType rhsCancellationConfirmation;
            rhsCancellationConfirmation = that.getCancellationConfirmation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cancellationConfirmation", lhsCancellationConfirmation), LocatorUtils.property(thatLocator, "cancellationConfirmation", rhsCancellationConfirmation), lhsCancellationConfirmation, rhsCancellationConfirmation, (this.cancellationConfirmation!= null), (that.cancellationConfirmation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerDescriptionType theCancelBy;
            theCancelBy = this.getCancelBy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cancelBy", theCancelBy), currentHashCode, theCancelBy, (this.cancelBy!= null));
        }
        {
            CancellationConfirmationType theCancellationConfirmation;
            theCancellationConfirmation = this.getCancellationConfirmation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cancellationConfirmation", theCancellationConfirmation), currentHashCode, theCancellationConfirmation, (this.cancellationConfirmation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SpecifiedPartnerDescriptionType theCancelBy;
            theCancelBy = this.getCancelBy();
            strategy.appendField(locator, this, "cancelBy", buffer, theCancelBy, (this.cancelBy!= null));
        }
        {
            CancellationConfirmationType theCancellationConfirmation;
            theCancellationConfirmation = this.getCancellationConfirmation();
            strategy.appendField(locator, this, "cancellationConfirmation", buffer, theCancellationConfirmation, (this.cancellationConfirmation!= null));
        }
        {
            OrderInformation theOrderInformation;
            theOrderInformation = this.getOrderInformation();
