...
public class ProductInformationObjectType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ActionCodeType lhsPIOActionCode;
            lhsPIOActionCode = this.getPIOActionCode();
            ActionCodeType rhsPIOActionCode;
            rhsPIOActionCode = that.getPIOActionCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "pioActionCode", lhsPIOActionCode), LocatorUtils.property(thatLocator, "pioActionCode", rhsPIOActionCode), lhsPIOActionCode, rhsPIOActionCode, (this.pioActionCode!= null), (that.pioActionCode!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ActionCodeType thePIOActionCode;
            thePIOActionCode = this.getPIOActionCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "pioActionCode", thePIOActionCode), currentHashCode, thePIOActionCode, (this.pioActionCode!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ActionCodeType thePIOActionCode;
            thePIOActionCode = this.getPIOActionCode();
            strategy.appendField(locator, this, "pioActionCode", buffer, thePIOActionCode, (this.pioActionCode!= null));
        }
        {
            ReferenceLocator theReferenceLocator;
            theReferenceLocator = this.getReferenceLocator();
