...
public class MaterialCompositionInformationDistributionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<ContactInformationType> lhsAuthorizer;
            lhsAuthorizer = (((this.authorizer!= null)&&(!this.authorizer.isEmpty()))?this.getAuthorizer():null);
            List<ContactInformationType> rhsAuthorizer;
            rhsAuthorizer = (((that.authorizer!= null)&&(!that.authorizer.isEmpty()))?that.getAuthorizer():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "authorizer", lhsAuthorizer), LocatorUtils.property(thatLocator, "authorizer", rhsAuthorizer), lhsAuthorizer, rhsAuthorizer, ((this.authorizer!= null)&&(!this.authorizer.isEmpty())), ((that.authorizer!= null)&&(!that.authorizer.isEmpty())))) {
                return false;
            }
        }
        {
            List<ContactInformationType> lhsCreator;
            lhsCreator = (((this.creator!= null)&&(!this.creator.isEmpty()))?this.getCreator():null);
            List<ContactInformationType> rhsCreator;
            rhsCreator = (((that.creator!= null)&&(!that.creator.isEmpty()))?that.getCreator():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "creator", lhsCreator), LocatorUtils.property(thatLocator, "creator", rhsCreator), lhsCreator, rhsCreator, ((this.creator!= null)&&(!this.creator.isEmpty())), ((that.creator!= null)&&(!that.creator.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<ContactInformationType> theAuthorizer;
            theAuthorizer = (((this.authorizer!= null)&&(!this.authorizer.isEmpty()))?this.getAuthorizer():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "authorizer", theAuthorizer), currentHashCode, theAuthorizer, ((this.authorizer!= null)&&(!this.authorizer.isEmpty())));
        }
        {
            List<ContactInformationType> theCreator;
            theCreator = (((this.creator!= null)&&(!this.creator.isEmpty()))?this.getCreator():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "creator", theCreator), currentHashCode, theCreator, ((this.creator!= null)&&(!this.creator.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<ContactInformationType> theAuthorizer;
            theAuthorizer = (((this.authorizer!= null)&&(!this.authorizer.isEmpty()))?this.getAuthorizer():null);
            strategy.appendField(locator, this, "authorizer", buffer, theAuthorizer, ((this.authorizer!= null)&&(!this.authorizer.isEmpty())));
        }
        {
            List<ContactInformationType> theCreator;
            theCreator = (((this.creator!= null)&&(!this.creator.isEmpty()))?this.getCreator():null);
            strategy.appendField(locator, this, "creator", buffer, theCreator, ((this.creator!= null)&&(!this.creator.isEmpty())));
        }
        {
            DocumentHeader theDocumentHeader;
            theDocumentHeader = this.getDocumentHeader();
