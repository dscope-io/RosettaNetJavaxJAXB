...
public class ProductInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ProductIdentifierType lhsAlternativeProductIdentifier;
            lhsAlternativeProductIdentifier = this.getAlternativeProductIdentifier();
            ProductIdentifierType rhsAlternativeProductIdentifier;
            rhsAlternativeProductIdentifier = that.getAlternativeProductIdentifier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "alternativeProductIdentifier", lhsAlternativeProductIdentifier), LocatorUtils.property(thatLocator, "alternativeProductIdentifier", rhsAlternativeProductIdentifier), lhsAlternativeProductIdentifier, rhsAlternativeProductIdentifier, (this.alternativeProductIdentifier!= null), (that.alternativeProductIdentifier!= null))) {
                return false;
            }
        }
        {
        ...
        {
            ActionCodeType lhsProductActionCode;
            lhsProductActionCode = this.getProductActionCode();
            ActionCodeType rhsProductActionCode;
            rhsProductActionCode = that.getProductActionCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productActionCode", lhsProductActionCode), LocatorUtils.property(thatLocator, "productActionCode", rhsProductActionCode), lhsProductActionCode, rhsProductActionCode, (this.productActionCode!= null), (that.productActionCode!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductIdentifierType theAlternativeProductIdentifier;
            theAlternativeProductIdentifier = this.getAlternativeProductIdentifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "alternativeProductIdentifier", theAlternativeProductIdentifier), currentHashCode, theAlternativeProductIdentifier, (this.alternativeProductIdentifier!= null));
        }
        {
        ...
        {
            ActionCodeType theProductActionCode;
            theProductActionCode = this.getProductActionCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "productActionCode", theProductActionCode), currentHashCode, theProductActionCode, (this.productActionCode!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ProductIdentifierType theAlternativeProductIdentifier;
            theAlternativeProductIdentifier = this.getAlternativeProductIdentifier();
            strategy.appendField(locator, this, "alternativeProductIdentifier", buffer, theAlternativeProductIdentifier, (this.alternativeProductIdentifier!= null));
        }
        {
            List<DependentCondition> theDependentCondition;
            theDependentCondition = (((this.dependentCondition!= null)&&(!this.dependentCondition.isEmpty()))?this.getDependentCondition():null);
        ...
        }
        {
            ActionCodeType theProductActionCode;
            theProductActionCode = this.getProductActionCode();
            strategy.appendField(locator, this, "productActionCode", buffer, theProductActionCode, (this.productActionCode!= null));
        }
        {
            ProductIdentifierType theProductIdentifier;
            theProductIdentifier = this.getProductIdentifier();
