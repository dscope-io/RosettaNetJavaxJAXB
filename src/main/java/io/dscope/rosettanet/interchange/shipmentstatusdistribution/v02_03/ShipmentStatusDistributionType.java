...
public class ShipmentStatusDistributionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentStatusDistributionType that = ((ShipmentStatusDistributionType) object);
        {
        ...
        {
            ShipmentStatusType lhsShipmentStatus;
            lhsShipmentStatus = this.getShipmentStatus();
            ShipmentStatusType rhsShipmentStatus;
            rhsShipmentStatus = that.getShipmentStatus();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "shipmentStatus", lhsShipmentStatus), LocatorUtils.property(thatLocator, "shipmentStatus", rhsShipmentStatus), lhsShipmentStatus, rhsShipmentStatus, (this.shipmentStatus!= null), (that.shipmentStatus!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentStatusType theShipmentStatus;
            theShipmentStatus = this.getShipmentStatus();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "shipmentStatus", theShipmentStatus), currentHashCode, theShipmentStatus, (this.shipmentStatus!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ShipmentStatusType theShipmentStatus;
            theShipmentStatus = this.getShipmentStatus();
            strategy.appendField(locator, this, "shipmentStatus", buffer, theShipmentStatus, (this.shipmentStatus!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
