...
public class InvoiceType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            PartnerDescriptionType lhsBillFrom;
            lhsBillFrom = this.getBillFrom();
            PartnerDescriptionType rhsBillFrom;
        ...
        {
            PartnerDescriptionType lhsBillTo;
            lhsBillTo = this.getBillTo();
            PartnerDescriptionType rhsBillTo;
        ...
        {
            PartnerDescriptionType lhsRemitTo;
            lhsRemitTo = this.getRemitTo();
            PartnerDescriptionType rhsRemitTo;
        ...
        {
            SpecifiedPartnerDescriptionType lhsTransferTo;
            lhsTransferTo = this.getTransferTo();
            SpecifiedPartnerDescriptionType rhsTransferTo;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PartnerDescriptionType theBillFrom;
        ...
        {
            PartnerDescriptionType theBillTo;
        ...
        {
            PartnerDescriptionType theRemitTo;
        ...
        {
            SpecifiedPartnerDescriptionType theTransferTo;
