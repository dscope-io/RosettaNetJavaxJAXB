...
public class ProductInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            PurchaseOrderStatusType lhsDispositionResult;
            lhsDispositionResult = this.getDispositionResult();
            PurchaseOrderStatusType rhsDispositionResult;
            rhsDispositionResult = that.getDispositionResult();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dispositionResult", lhsDispositionResult), LocatorUtils.property(thatLocator, "dispositionResult", rhsDispositionResult), lhsDispositionResult, rhsDispositionResult, (this.dispositionResult!= null), (that.dispositionResult!= null))) {
                return false;
            }
        }
        {
        ...
        {
            RejectionReason lhsRejectionReason;
            lhsRejectionReason = this.getRejectionReason();
            RejectionReason rhsRejectionReason;
            rhsRejectionReason = that.getRejectionReason();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rejectionReason", lhsRejectionReason), LocatorUtils.property(thatLocator, "rejectionReason", rhsRejectionReason), lhsRejectionReason, rhsRejectionReason, (this.rejectionReason!= null), (that.rejectionReason!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderStatusType theDispositionResult;
            theDispositionResult = this.getDispositionResult();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dispositionResult", theDispositionResult), currentHashCode, theDispositionResult, (this.dispositionResult!= null));
        }
        {
        ...
        {
            RejectionReason theRejectionReason;
            theRejectionReason = this.getRejectionReason();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "rejectionReason", theRejectionReason), currentHashCode, theRejectionReason, (this.rejectionReason!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            PurchaseOrderStatusType theDispositionResult;
            theDispositionResult = this.getDispositionResult();
            strategy.appendField(locator, this, "dispositionResult", buffer, theDispositionResult, (this.dispositionResult!= null));
        }
        {
            PricingInformationType theDistributorPricing;
            theDistributorPricing = this.getDistributorPricing();
        ...
        }
        {
            RejectionReason theRejectionReason;
            theRejectionReason = this.getRejectionReason();
            strategy.appendField(locator, this, "rejectionReason", buffer, theRejectionReason, (this.rejectionReason!= null));
        }
        {
            XMLGregorianCalendar theShipDate;
            theShipDate = this.getShipDate();
