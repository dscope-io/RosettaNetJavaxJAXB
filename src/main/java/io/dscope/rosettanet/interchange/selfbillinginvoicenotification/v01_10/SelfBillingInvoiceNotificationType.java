...
public class SelfBillingInvoiceNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SelfBillingInvoiceNotificationType that = ((SelfBillingInvoiceNotificationType) object);
        {
        ...
        {
            InvoiceType lhsInvoice;
            lhsInvoice = this.getInvoice();
            InvoiceType rhsInvoice;
            rhsInvoice = that.getInvoice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "invoice", lhsInvoice), LocatorUtils.property(thatLocator, "invoice", rhsInvoice), lhsInvoice, rhsInvoice, (this.invoice!= null), (that.invoice!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InvoiceType theInvoice;
            theInvoice = this.getInvoice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "invoice", theInvoice), currentHashCode, theInvoice, (this.invoice!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            InvoiceType theInvoice;
            theInvoice = this.getInvoice();
            strategy.appendField(locator, this, "invoice", buffer, theInvoice, (this.invoice!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
