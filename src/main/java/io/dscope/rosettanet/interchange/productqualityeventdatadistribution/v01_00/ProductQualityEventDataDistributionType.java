...
public class ProductQualityEventDataDistributionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductQualityEventDataDistributionType that = ((ProductQualityEventDataDistributionType) object);
        {
        ...
        {
            ProductQualityEventDataType lhsProductQualityEventData;
            lhsProductQualityEventData = this.getProductQualityEventData();
            ProductQualityEventDataType rhsProductQualityEventData;
            rhsProductQualityEventData = that.getProductQualityEventData();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productQualityEventData", lhsProductQualityEventData), LocatorUtils.property(thatLocator, "productQualityEventData", rhsProductQualityEventData), lhsProductQualityEventData, rhsProductQualityEventData, (this.productQualityEventData!= null), (that.productQualityEventData!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductQualityEventDataType theProductQualityEventData;
            theProductQualityEventData = this.getProductQualityEventData();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "productQualityEventData", theProductQualityEventData), currentHashCode, theProductQualityEventData, (this.productQualityEventData!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ProductQualityEventDataType theProductQualityEventData;
            theProductQualityEventData = this.getProductQualityEventData();
            strategy.appendField(locator, this, "productQualityEventData", buffer, theProductQualityEventData, (this.productQualityEventData!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
