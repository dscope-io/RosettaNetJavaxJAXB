...
public class ProductMasterDistributionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductMasterDistributionType that = ((ProductMasterDistributionType) object);
        {
        ...
        {
            ProductMasterType lhsProductMaster;
            lhsProductMaster = this.getProductMaster();
            ProductMasterType rhsProductMaster;
            rhsProductMaster = that.getProductMaster();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productMaster", lhsProductMaster), LocatorUtils.property(thatLocator, "productMaster", rhsProductMaster), lhsProductMaster, rhsProductMaster, (this.productMaster!= null), (that.productMaster!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductMasterType theProductMaster;
            theProductMaster = this.getProductMaster();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "productMaster", theProductMaster), currentHashCode, theProductMaster, (this.productMaster!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ProductMasterType theProductMaster;
            theProductMaster = this.getProductMaster();
            strategy.appendField(locator, this, "productMaster", buffer, theProductMaster, (this.productMaster!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
