...
public class ItemComplianceType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ItemComplianceType that = ((ItemComplianceType) object);
        {
            String lhsAttribute;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "attribute", theAttribute), currentHashCode, theAttribute, (this.attribute!= null));
        }
        {
            String theValue;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theAttribute;
            theAttribute = this.getAttribute();
            strategy.appendField(locator, this, "attribute", buffer, theAttribute, (this.attribute!= null));
        }
        {
            String theValue;
            theValue = this.getValue();
