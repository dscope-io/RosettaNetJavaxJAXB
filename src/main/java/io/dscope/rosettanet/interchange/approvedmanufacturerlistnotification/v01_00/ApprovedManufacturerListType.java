...
public class ApprovedManufacturerListType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<SpecifiedPartnerDescriptionType> lhsInternalBusinessEntity;
            ...
            List<SpecifiedPartnerDescriptionType> rhsInternalBusinessEntity;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<SpecifiedPartnerDescriptionType> theInternalBusinessEntity;
