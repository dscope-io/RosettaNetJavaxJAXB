...
public class StockIndicatorType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final StockIndicatorType that = ((StockIndicatorType) object);
        {
            StockIndicatorContentType lhsValue;
            lhsValue = this.getValue();
            StockIndicatorContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            StockIndicatorContentType theValue;
