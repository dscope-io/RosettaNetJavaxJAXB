...
public class QuoteLineItemStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuoteLineItemStatusType that = ((QuoteLineItemStatusType) object);
        {
            QuoteLineItemStatusContentType lhsValue;
            lhsValue = this.getValue();
            QuoteLineItemStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QuoteLineItemStatusContentType theValue;
