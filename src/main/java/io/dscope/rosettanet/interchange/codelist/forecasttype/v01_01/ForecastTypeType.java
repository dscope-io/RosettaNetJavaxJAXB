...
public class ForecastTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ForecastTypeType that = ((ForecastTypeType) object);
        {
            ForecastTypeContentType lhsValue;
            lhsValue = this.getValue();
            ForecastTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ForecastTypeContentType theValue;
