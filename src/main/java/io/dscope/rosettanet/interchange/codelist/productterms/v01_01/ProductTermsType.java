...
public class ProductTermsType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductTermsType that = ((ProductTermsType) object);
        {
            ProductTermsContentType lhsValue;
            lhsValue = this.getValue();
            ProductTermsContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductTermsContentType theValue;
