...
public class FileTransmissionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FileTransmissionType that = ((FileTransmissionType) object);
        {
            FileTransmissionContentType lhsValue;
            lhsValue = this.getValue();
            FileTransmissionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FileTransmissionContentType theValue;
