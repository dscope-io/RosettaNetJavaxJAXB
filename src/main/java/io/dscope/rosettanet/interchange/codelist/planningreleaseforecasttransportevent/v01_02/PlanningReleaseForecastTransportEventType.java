...
public class PlanningReleaseForecastTransportEventType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PlanningReleaseForecastTransportEventType that = ((PlanningReleaseForecastTransportEventType) object);
        {
            PlanningReleaseForecastTransportEventContentType lhsValue;
            lhsValue = this.getValue();
            PlanningReleaseForecastTransportEventContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PlanningReleaseForecastTransportEventContentType theValue;
