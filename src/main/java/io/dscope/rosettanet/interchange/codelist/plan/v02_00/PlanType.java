...
public class PlanType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PlanType that = ((PlanType) object);
        {
            PlanContentType lhsValue;
            lhsValue = this.getValue();
            PlanContentType rhsValue;
