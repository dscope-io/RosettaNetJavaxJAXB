...
public class PhaseType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PhaseType that = ((PhaseType) object);
        {
            PhaseContentType lhsValue;
            lhsValue = this.getValue();
            PhaseContentType rhsValue;
