...
public class ShipmentStatusReportingLevelType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentStatusReportingLevelType that = ((ShipmentStatusReportingLevelType) object);
        {
            ShipmentStatusReportingLevelContentType lhsValue;
            lhsValue = this.getValue();
            ShipmentStatusReportingLevelContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentStatusReportingLevelContentType theValue;
