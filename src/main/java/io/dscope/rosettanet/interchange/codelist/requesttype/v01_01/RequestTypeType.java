...
public class RequestTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RequestTypeType that = ((RequestTypeType) object);
        {
            RequestTypeContentType lhsValue;
            lhsValue = this.getValue();
            RequestTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RequestTypeContentType theValue;
