...
public class LeadTimeCommencementType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LeadTimeCommencementType that = ((LeadTimeCommencementType) object);
        {
            LeadTimeCommencementContentType lhsValue;
            lhsValue = this.getValue();
            LeadTimeCommencementContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LeadTimeCommencementContentType theValue;
