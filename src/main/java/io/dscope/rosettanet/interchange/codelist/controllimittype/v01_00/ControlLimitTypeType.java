...
public class ControlLimitTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ControlLimitTypeType that = ((ControlLimitTypeType) object);
        {
            ControlLimitTypeContentType lhsValue;
            lhsValue = this.getValue();
            ControlLimitTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ControlLimitTypeContentType theValue;
