...
public class DeliveryTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DeliveryTypeType that = ((DeliveryTypeType) object);
        {
            DeliveryTypeContentType lhsValue;
            lhsValue = this.getValue();
            DeliveryTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DeliveryTypeContentType theValue;
