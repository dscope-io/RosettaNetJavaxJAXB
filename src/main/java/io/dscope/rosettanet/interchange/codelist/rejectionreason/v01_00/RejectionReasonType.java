...
public class RejectionReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RejectionReasonType that = ((RejectionReasonType) object);
        {
            RejectionReasonContentType lhsValue;
            lhsValue = this.getValue();
            RejectionReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RejectionReasonContentType theValue;
