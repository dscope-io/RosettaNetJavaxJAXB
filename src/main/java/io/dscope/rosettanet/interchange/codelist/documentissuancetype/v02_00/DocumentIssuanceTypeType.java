...
public class DocumentIssuanceTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DocumentIssuanceTypeType that = ((DocumentIssuanceTypeType) object);
        {
            DocumentIssuanceTypeContentType lhsValue;
            lhsValue = this.getValue();
            DocumentIssuanceTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DocumentIssuanceTypeContentType theValue;
