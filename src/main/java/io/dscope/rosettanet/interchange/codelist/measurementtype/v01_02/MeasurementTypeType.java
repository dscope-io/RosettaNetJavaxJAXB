...
public class MeasurementTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MeasurementTypeType that = ((MeasurementTypeType) object);
        {
            MeasurementTypeContentType lhsValue;
            lhsValue = this.getValue();
            MeasurementTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            MeasurementTypeContentType theValue;
