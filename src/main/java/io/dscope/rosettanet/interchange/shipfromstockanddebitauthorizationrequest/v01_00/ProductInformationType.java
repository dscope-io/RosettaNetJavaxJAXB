...
public class ProductInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<ProductPricingType> lhsDistributorPricing;
            lhsDistributorPricing = (((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty()))?this.getDistributorPricing():null);
            List<ProductPricingType> rhsDistributorPricing;
            rhsDistributorPricing = (((that.distributorPricing!= null)&&(!that.distributorPricing.isEmpty()))?that.getDistributorPricing():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "distributorPricing", lhsDistributorPricing), LocatorUtils.property(thatLocator, "distributorPricing", rhsDistributorPricing), lhsDistributorPricing, rhsDistributorPricing, ((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty())), ((that.distributorPricing!= null)&&(!that.distributorPricing.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<ProductPricingType> theDistributorPricing;
            theDistributorPricing = (((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty()))?this.getDistributorPricing():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "distributorPricing", theDistributorPricing), currentHashCode, theDistributorPricing, ((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<ProductPricingType> theDistributorPricing;
            theDistributorPricing = (((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty()))?this.getDistributorPricing():null);
            strategy.appendField(locator, this, "distributorPricing", buffer, theDistributorPricing, ((this.distributorPricing!= null)&&(!this.distributorPricing.isEmpty())));
        }
        {
            ProductIdentification theProductIdentification;
            theProductIdentification = this.getProductIdentification();
