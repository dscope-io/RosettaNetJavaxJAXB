...
public class DeviceActivationNumberType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DeviceActivationNumberType that = ((DeviceActivationNumberType) object);
        {
        ...
        {
            String lhsCalledNumberIdentifier;
            lhsCalledNumberIdentifier = this.getCalledNumberIdentifier();
            String rhsCalledNumberIdentifier;
            rhsCalledNumberIdentifier = that.getCalledNumberIdentifier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "calledNumberIdentifier", lhsCalledNumberIdentifier), LocatorUtils.property(thatLocator, "calledNumberIdentifier", rhsCalledNumberIdentifier), lhsCalledNumberIdentifier, rhsCalledNumberIdentifier, (this.calledNumberIdentifier!= null), (that.calledNumberIdentifier!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theCalledNumberIdentifier;
            theCalledNumberIdentifier = this.getCalledNumberIdentifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "calledNumberIdentifier", theCalledNumberIdentifier), currentHashCode, theCalledNumberIdentifier, (this.calledNumberIdentifier!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theCalledNumberIdentifier;
            theCalledNumberIdentifier = this.getCalledNumberIdentifier();
            strategy.appendField(locator, this, "calledNumberIdentifier", buffer, theCalledNumberIdentifier, (this.calledNumberIdentifier!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
