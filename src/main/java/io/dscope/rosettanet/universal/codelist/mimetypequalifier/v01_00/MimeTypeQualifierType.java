...
public class MimeTypeQualifierType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MimeTypeQualifierType that = ((MimeTypeQualifierType) object);
        {
            MimeTypeQualifierContentType lhsValue;
            lhsValue = this.getValue();
            MimeTypeQualifierContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            MimeTypeQualifierContentType theValue;
