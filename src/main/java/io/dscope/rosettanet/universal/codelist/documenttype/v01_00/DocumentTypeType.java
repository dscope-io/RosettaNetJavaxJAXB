...
public class DocumentTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DocumentTypeType that = ((DocumentTypeType) object);
        {
            DocumentTypeContentType lhsValue;
            lhsValue = this.getValue();
            DocumentTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DocumentTypeContentType theValue;
