...
public class TaxTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TaxTypeType that = ((TaxTypeType) object);
        {
            TaxTypeContentType lhsValue;
            lhsValue = this.getValue();
            TaxTypeContentType rhsValue;
