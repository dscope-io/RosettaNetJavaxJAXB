...
public class WeightTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WeightTypeType that = ((WeightTypeType) object);
        {
            WeightTypeContentType lhsValue;
            lhsValue = this.getValue();
            WeightTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WeightTypeContentType theValue;
