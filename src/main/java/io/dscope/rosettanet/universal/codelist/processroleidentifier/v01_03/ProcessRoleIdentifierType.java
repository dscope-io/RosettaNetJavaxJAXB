...
public class ProcessRoleIdentifierType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProcessRoleIdentifierType that = ((ProcessRoleIdentifierType) object);
        {
            ProcessRoleIdentifierContentType lhsValue;
            lhsValue = this.getValue();
            ProcessRoleIdentifierContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProcessRoleIdentifierContentType theValue;
