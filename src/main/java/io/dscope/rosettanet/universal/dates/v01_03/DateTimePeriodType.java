...
public class DateTimePeriodType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DateTimePeriodType that = ((DateTimePeriodType) object);
        {
            XMLGregorianCalendar lhsBegin;
            lhsBegin = this.getBegin();
            XMLGregorianCalendar rhsBegin;
