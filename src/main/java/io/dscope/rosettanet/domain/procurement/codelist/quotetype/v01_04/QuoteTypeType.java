...
public class QuoteTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuoteTypeType that = ((QuoteTypeType) object);
        {
            QuoteTypeContentType lhsValue;
            lhsValue = this.getValue();
            QuoteTypeContentType rhsValue;
