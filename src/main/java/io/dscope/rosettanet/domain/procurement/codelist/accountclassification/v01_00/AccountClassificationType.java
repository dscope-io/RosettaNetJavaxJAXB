...
public class AccountClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AccountClassificationType that = ((AccountClassificationType) object);
        {
            AccountClassificationContentType lhsValue;
            lhsValue = this.getValue();
            AccountClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            AccountClassificationContentType theValue;
