...
public class SpecialFulfillmentRequestType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SpecialFulfillmentRequestType that = ((SpecialFulfillmentRequestType) object);
        {
            SpecialFulfillmentRequestContentType lhsValue;
            lhsValue = this.getValue();
            SpecialFulfillmentRequestContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecialFulfillmentRequestContentType theValue;
