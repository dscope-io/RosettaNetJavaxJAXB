...
public class ProductProcurementTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductProcurementTypeType that = ((ProductProcurementTypeType) object);
        {
            ProductProcurementTypeContentType lhsValue;
            lhsValue = this.getValue();
            ProductProcurementTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductProcurementTypeContentType theValue;
