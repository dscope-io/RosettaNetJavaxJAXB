...
public class SaleTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SaleTypeType that = ((SaleTypeType) object);
        {
            SaleTypeContentType lhsValue;
            lhsValue = this.getValue();
            SaleTypeContentType rhsValue;
