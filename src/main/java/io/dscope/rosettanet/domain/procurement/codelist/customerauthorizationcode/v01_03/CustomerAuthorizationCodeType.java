...
public class CustomerAuthorizationCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CustomerAuthorizationCodeType that = ((CustomerAuthorizationCodeType) object);
        {
            CustomerAuthorizationCodeContentType lhsValue;
            lhsValue = this.getValue();
            CustomerAuthorizationCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CustomerAuthorizationCodeContentType theValue;
