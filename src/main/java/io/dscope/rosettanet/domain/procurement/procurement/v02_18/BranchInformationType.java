...
public class BranchInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BranchInformationType that = ((BranchInformationType) object);
        {
            CustomerInformation lhsCustomerInformation;
            lhsCustomerInformation = this.getCustomerInformation();
            CustomerInformation rhsCustomerInformation;
            rhsCustomerInformation = that.getCustomerInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customerInformation", lhsCustomerInformation), LocatorUtils.property(thatLocator, "customerInformation", rhsCustomerInformation), lhsCustomerInformation, rhsCustomerInformation, (this.customerInformation!= null), (that.customerInformation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CustomerInformation theCustomerInformation;
            theCustomerInformation = this.getCustomerInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customerInformation", theCustomerInformation), currentHashCode, theCustomerInformation, (this.customerInformation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            CustomerInformation theCustomerInformation;
            theCustomerInformation = this.getCustomerInformation();
            strategy.appendField(locator, this, "customerInformation", buffer, theCustomerInformation, (this.customerInformation!= null));
        }
        {
            SpecifiedPartnerDescriptionType theDistributedBy;
            theDistributedBy = this.getDistributedBy();
