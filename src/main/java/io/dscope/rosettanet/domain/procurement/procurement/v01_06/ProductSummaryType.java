...
public class ProductSummaryType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductSummaryType that = ((ProductSummaryType) object);
        {
        ...
        {
            List<ProductUnitTotal> lhsProductUnitTotal;
            lhsProductUnitTotal = (((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty()))?this.getProductUnitTotal():null);
            List<ProductUnitTotal> rhsProductUnitTotal;
            rhsProductUnitTotal = (((that.productUnitTotal!= null)&&(!that.productUnitTotal.isEmpty()))?that.getProductUnitTotal():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productUnitTotal", lhsProductUnitTotal), LocatorUtils.property(thatLocator, "productUnitTotal", rhsProductUnitTotal), lhsProductUnitTotal, rhsProductUnitTotal, ((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty())), ((that.productUnitTotal!= null)&&(!that.productUnitTotal.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<ProductUnitTotal> theProductUnitTotal;
            theProductUnitTotal = (((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty()))?this.getProductUnitTotal():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "productUnitTotal", theProductUnitTotal), currentHashCode, theProductUnitTotal, ((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<ProductUnitTotal> theProductUnitTotal;
            theProductUnitTotal = (((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty()))?this.getProductUnitTotal():null);
            strategy.appendField(locator, this, "productUnitTotal", buffer, theProductUnitTotal, ((this.productUnitTotal!= null)&&(!this.productUnitTotal.isEmpty())));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
