...
public class PurchaseOrderTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderTypeType that = ((PurchaseOrderTypeType) object);
        {
            PurchaseOrderTypeContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderTypeContentType theValue;
