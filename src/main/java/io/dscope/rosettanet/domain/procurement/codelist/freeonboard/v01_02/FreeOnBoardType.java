...
public class FreeOnBoardType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FreeOnBoardType that = ((FreeOnBoardType) object);
        {
            FreeOnBoardContentType lhsValue;
            lhsValue = this.getValue();
            FreeOnBoardContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FreeOnBoardContentType theValue;
