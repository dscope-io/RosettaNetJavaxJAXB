...
public class GovernmentPriorityRatingType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GovernmentPriorityRatingType that = ((GovernmentPriorityRatingType) object);
        {
            GovernmentPriorityRatingContentType lhsValue;
            lhsValue = this.getValue();
            GovernmentPriorityRatingContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            GovernmentPriorityRatingContentType theValue;
