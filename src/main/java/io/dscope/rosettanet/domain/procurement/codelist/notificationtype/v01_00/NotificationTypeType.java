...
public class NotificationTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NotificationTypeType that = ((NotificationTypeType) object);
        {
            NotificationTypeContentType lhsValue;
            lhsValue = this.getValue();
            NotificationTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            NotificationTypeContentType theValue;
