...
public class FinancialAdjustmentReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FinancialAdjustmentReasonType that = ((FinancialAdjustmentReasonType) object);
        {
            FinancialAdjustmentReasonContentType lhsValue;
            lhsValue = this.getValue();
            FinancialAdjustmentReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FinancialAdjustmentReasonContentType theValue;
