...
public class TaxExemptionCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TaxExemptionCodeType that = ((TaxExemptionCodeType) object);
        {
            TaxExemptionCodeContentType lhsValue;
            lhsValue = this.getValue();
            TaxExemptionCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TaxExemptionCodeContentType theValue;
