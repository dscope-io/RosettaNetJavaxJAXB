...
public class FinanceTermsType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FinanceTermsType that = ((FinanceTermsType) object);
        {
            FinanceTermsContentType lhsValue;
            lhsValue = this.getValue();
            FinanceTermsContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FinanceTermsContentType theValue;
