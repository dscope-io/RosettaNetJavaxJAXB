...
public class LeadTimeClassificationCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LeadTimeClassificationCodeType that = ((LeadTimeClassificationCodeType) object);
        {
            LeadTimeClassificationCodeContentType lhsValue;
            lhsValue = this.getValue();
            LeadTimeClassificationCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LeadTimeClassificationCodeContentType theValue;
