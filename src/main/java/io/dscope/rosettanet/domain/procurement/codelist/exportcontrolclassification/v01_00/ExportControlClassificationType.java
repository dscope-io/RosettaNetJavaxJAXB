...
public class ExportControlClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ExportControlClassificationType that = ((ExportControlClassificationType) object);
        {
            ExportControlClassificationContentType lhsValue;
            lhsValue = this.getValue();
            ExportControlClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ExportControlClassificationContentType theValue;
