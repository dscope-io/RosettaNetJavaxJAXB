...
public class CustomerTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CustomerTypeType that = ((CustomerTypeType) object);
        {
            CustomerTypeContentType lhsValue;
            lhsValue = this.getValue();
            CustomerTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CustomerTypeContentType theValue;
