...
public class InvoiceRejectionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InvoiceRejectionType that = ((InvoiceRejectionType) object);
        {
            InvoiceRejectionContentType lhsValue;
            lhsValue = this.getValue();
            InvoiceRejectionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InvoiceRejectionContentType theValue;
