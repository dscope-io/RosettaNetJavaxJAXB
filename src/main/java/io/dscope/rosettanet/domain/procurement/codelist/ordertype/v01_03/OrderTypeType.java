...
public class OrderTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OrderTypeType that = ((OrderTypeType) object);
        {
            OrderTypeContentType lhsValue;
            lhsValue = this.getValue();
            OrderTypeContentType rhsValue;
