...
public class RejectionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RejectionType that = ((RejectionType) object);
        {
            RejectionContentType lhsValue;
            lhsValue = this.getValue();
            RejectionContentType rhsValue;
