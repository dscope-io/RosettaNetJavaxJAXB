...
public class PurchaseOrderCancellationReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderCancellationReasonType that = ((PurchaseOrderCancellationReasonType) object);
        {
            PurchaseOrderCancellationReasonContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderCancellationReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderCancellationReasonContentType theValue;
