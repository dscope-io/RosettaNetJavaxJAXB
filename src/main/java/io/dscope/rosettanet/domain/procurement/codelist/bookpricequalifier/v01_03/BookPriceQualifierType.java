...
public class BookPriceQualifierType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BookPriceQualifierType that = ((BookPriceQualifierType) object);
        {
            BookPriceQualifierContentType lhsValue;
            lhsValue = this.getValue();
            BookPriceQualifierContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            BookPriceQualifierContentType theValue;
