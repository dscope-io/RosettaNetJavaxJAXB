...
public class ProductStatusCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductStatusCodeType that = ((ProductStatusCodeType) object);
        {
            ProductStatusCodeContentType lhsValue;
            lhsValue = this.getValue();
            ProductStatusCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductStatusCodeContentType theValue;
