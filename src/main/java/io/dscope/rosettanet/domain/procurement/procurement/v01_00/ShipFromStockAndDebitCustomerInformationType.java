...
public class ShipFromStockAndDebitCustomerInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipFromStockAndDebitCustomerInformationType that = ((ShipFromStockAndDebitCustomerInformationType) object);
        {
        ...
        {
            List<SpecifiedPartnerDescriptionType> lhsUsedBy;
            lhsUsedBy = (((this.usedBy!= null)&&(!this.usedBy.isEmpty()))?this.getUsedBy():null);
            List<SpecifiedPartnerDescriptionType> rhsUsedBy;
            rhsUsedBy = (((that.usedBy!= null)&&(!that.usedBy.isEmpty()))?that.getUsedBy():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "usedBy", lhsUsedBy), LocatorUtils.property(thatLocator, "usedBy", rhsUsedBy), lhsUsedBy, rhsUsedBy, ((this.usedBy!= null)&&(!this.usedBy.isEmpty())), ((that.usedBy!= null)&&(!that.usedBy.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<SpecifiedPartnerDescriptionType> theUsedBy;
            theUsedBy = (((this.usedBy!= null)&&(!this.usedBy.isEmpty()))?this.getUsedBy():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "usedBy", theUsedBy), currentHashCode, theUsedBy, ((this.usedBy!= null)&&(!this.usedBy.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<SpecifiedPartnerDescriptionType> theUsedBy;
            theUsedBy = (((this.usedBy!= null)&&(!this.usedBy.isEmpty()))?this.getUsedBy():null);
            strategy.appendField(locator, this, "usedBy", buffer, theUsedBy, ((this.usedBy!= null)&&(!this.usedBy.isEmpty())));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
