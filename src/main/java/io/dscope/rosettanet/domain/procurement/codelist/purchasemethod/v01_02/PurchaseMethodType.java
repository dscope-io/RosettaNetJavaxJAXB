...
public class PurchaseMethodType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseMethodType that = ((PurchaseMethodType) object);
        {
            PurchaseMethodContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseMethodContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseMethodContentType theValue;
