...
public class RevisionReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RevisionReasonType that = ((RevisionReasonType) object);
        {
            RevisionReasonContentType lhsValue;
            lhsValue = this.getValue();
            RevisionReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RevisionReasonContentType theValue;
