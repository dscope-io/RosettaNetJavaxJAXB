...
public class ReportTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReportTypeType that = ((ReportTypeType) object);
        {
            ReportTypeContentType lhsValue;
            lhsValue = this.getValue();
            ReportTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReportTypeContentType theValue;
