...
public class PurchaseOrderAcknowledgmentReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderAcknowledgmentReasonType that = ((PurchaseOrderAcknowledgmentReasonType) object);
        {
            PurchaseOrderAcknowledgmentReasonContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderAcknowledgmentReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderAcknowledgmentReasonContentType theValue;
