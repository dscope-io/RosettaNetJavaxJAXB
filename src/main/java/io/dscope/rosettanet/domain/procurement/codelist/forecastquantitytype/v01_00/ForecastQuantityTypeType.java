...
public class ForecastQuantityTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ForecastQuantityTypeType that = ((ForecastQuantityTypeType) object);
        {
            ForecastQuantityTypeContentType lhsValue;
            lhsValue = this.getValue();
            ForecastQuantityTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ForecastQuantityTypeContentType theValue;
