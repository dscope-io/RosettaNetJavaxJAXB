...
public class PurchaseOrderChangeTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderChangeTypeType that = ((PurchaseOrderChangeTypeType) object);
        {
            PurchaseOrderChangeTypeContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderChangeTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderChangeTypeContentType theValue;
