...
public class QuoteAcknowledgmentReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuoteAcknowledgmentReasonType that = ((QuoteAcknowledgmentReasonType) object);
        {
            QuoteAcknowledgmentReasonContentType lhsValue;
            lhsValue = this.getValue();
            QuoteAcknowledgmentReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QuoteAcknowledgmentReasonContentType theValue;
