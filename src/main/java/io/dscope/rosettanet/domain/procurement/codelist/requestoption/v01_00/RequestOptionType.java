...
public class RequestOptionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RequestOptionType that = ((RequestOptionType) object);
        {
            RequestOptionContentType lhsValue;
            lhsValue = this.getValue();
            RequestOptionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RequestOptionContentType theValue;
