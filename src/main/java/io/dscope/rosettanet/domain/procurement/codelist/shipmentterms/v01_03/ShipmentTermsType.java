...
public class ShipmentTermsType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentTermsType that = ((ShipmentTermsType) object);
        {
            ShipmentTermsContentType lhsValue;
            lhsValue = this.getValue();
            ShipmentTermsContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentTermsContentType theValue;
