...
public class ForecastEventType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ForecastEventType that = ((ForecastEventType) object);
        {
            ForecastEventContentType lhsValue;
            lhsValue = this.getValue();
            ForecastEventContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ForecastEventContentType theValue;
