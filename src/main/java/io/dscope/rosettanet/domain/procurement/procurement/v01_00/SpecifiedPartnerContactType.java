...
public class SpecifiedPartnerContactType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SpecifiedPartnerContactType that = ((SpecifiedPartnerContactType) object);
        {
        ...
        {
            SpecifiedPartnerLocation lhsSpecifiedPartnerLocation;
            lhsSpecifiedPartnerLocation = this.getSpecifiedPartnerLocation();
            SpecifiedPartnerLocation rhsSpecifiedPartnerLocation;
            rhsSpecifiedPartnerLocation = that.getSpecifiedPartnerLocation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "specifiedPartnerLocation", lhsSpecifiedPartnerLocation), LocatorUtils.property(thatLocator, "specifiedPartnerLocation", rhsSpecifiedPartnerLocation), lhsSpecifiedPartnerLocation, rhsSpecifiedPartnerLocation, (this.specifiedPartnerLocation!= null), (that.specifiedPartnerLocation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerLocation theSpecifiedPartnerLocation;
            theSpecifiedPartnerLocation = this.getSpecifiedPartnerLocation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "specifiedPartnerLocation", theSpecifiedPartnerLocation), currentHashCode, theSpecifiedPartnerLocation, (this.specifiedPartnerLocation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            SpecifiedPartnerLocation theSpecifiedPartnerLocation;
            theSpecifiedPartnerLocation = this.getSpecifiedPartnerLocation();
            strategy.appendField(locator, this, "specifiedPartnerLocation", buffer, theSpecifiedPartnerLocation, (this.specifiedPartnerLocation!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
