...
public class PurchaseOrderFillPriorityType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderFillPriorityType that = ((PurchaseOrderFillPriorityType) object);
        {
            PurchaseOrderFillPriorityContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderFillPriorityContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderFillPriorityContentType theValue;
