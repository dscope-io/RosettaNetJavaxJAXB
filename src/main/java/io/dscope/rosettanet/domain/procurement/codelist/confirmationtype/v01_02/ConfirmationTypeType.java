...
public class ConfirmationTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConfirmationTypeType that = ((ConfirmationTypeType) object);
        {
            ConfirmationTypeContentType lhsValue;
            lhsValue = this.getValue();
            ConfirmationTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ConfirmationTypeContentType theValue;
