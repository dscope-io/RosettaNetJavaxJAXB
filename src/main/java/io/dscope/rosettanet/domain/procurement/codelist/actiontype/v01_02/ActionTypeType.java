...
public class ActionTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ActionTypeType that = ((ActionTypeType) object);
        {
            ActionTypeContentType lhsValue;
            lhsValue = this.getValue();
            ActionTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ActionTypeContentType theValue;
