...
public class PaymentConditionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PaymentConditionType that = ((PaymentConditionType) object);
        {
            PaymentConditionContentType lhsValue;
            lhsValue = this.getValue();
            PaymentConditionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PaymentConditionContentType theValue;
