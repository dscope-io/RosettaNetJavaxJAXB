...
public class DateTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DateTypeType that = ((DateTypeType) object);
        {
            DateTypeContentType lhsValue;
            lhsValue = this.getValue();
            DateTypeContentType rhsValue;
