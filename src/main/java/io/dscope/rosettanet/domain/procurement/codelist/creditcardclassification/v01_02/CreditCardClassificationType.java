...
public class CreditCardClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CreditCardClassificationType that = ((CreditCardClassificationType) object);
        {
            CreditCardClassificationContentType lhsValue;
            lhsValue = this.getValue();
            CreditCardClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CreditCardClassificationContentType theValue;
