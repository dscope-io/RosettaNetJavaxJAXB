...
public class RequoteActionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RequoteActionType that = ((RequoteActionType) object);
        {
            RequoteActionContentType lhsValue;
            lhsValue = this.getValue();
            RequoteActionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RequoteActionContentType theValue;
