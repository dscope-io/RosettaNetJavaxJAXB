...
public class LineItemStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LineItemStatusType that = ((LineItemStatusType) object);
        {
            LineItemStatusContentType lhsValue;
            lhsValue = this.getValue();
            LineItemStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LineItemStatusContentType theValue;
