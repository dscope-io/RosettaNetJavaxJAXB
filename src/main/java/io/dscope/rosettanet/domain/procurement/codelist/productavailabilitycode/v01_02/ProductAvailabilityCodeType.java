...
public class ProductAvailabilityCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductAvailabilityCodeType that = ((ProductAvailabilityCodeType) object);
        {
            ProductAvailabilityCodeContentType lhsValue;
            lhsValue = this.getValue();
            ProductAvailabilityCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductAvailabilityCodeContentType theValue;
