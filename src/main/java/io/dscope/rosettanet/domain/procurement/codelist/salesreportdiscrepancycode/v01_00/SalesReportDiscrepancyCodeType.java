...
public class SalesReportDiscrepancyCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SalesReportDiscrepancyCodeType that = ((SalesReportDiscrepancyCodeType) object);
        {
            SalesReportDiscrepancyCodeContentType lhsValue;
            lhsValue = this.getValue();
            SalesReportDiscrepancyCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SalesReportDiscrepancyCodeContentType theValue;
