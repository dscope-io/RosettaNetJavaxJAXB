...
public class PurchaseTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseTypeType that = ((PurchaseTypeType) object);
        {
            PurchaseTypeContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseTypeContentType theValue;
