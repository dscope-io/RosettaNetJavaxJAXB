...
public class PricingTypeCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PricingTypeCodeType that = ((PricingTypeCodeType) object);
        {
            PricingTypeCodeContentType lhsValue;
            lhsValue = this.getValue();
            PricingTypeCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PricingTypeCodeContentType theValue;
