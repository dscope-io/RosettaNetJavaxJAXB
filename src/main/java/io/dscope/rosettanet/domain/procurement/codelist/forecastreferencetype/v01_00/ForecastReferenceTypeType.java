...
public class ForecastReferenceTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ForecastReferenceTypeType that = ((ForecastReferenceTypeType) object);
        {
            ForecastReferenceTypeContentType lhsValue;
            lhsValue = this.getValue();
            ForecastReferenceTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ForecastReferenceTypeContentType theValue;
