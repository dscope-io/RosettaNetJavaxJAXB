...
public class TransportationEventType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TransportationEventType that = ((TransportationEventType) object);
        {
            DateTimePeriod lhsDateTimePeriod;
            lhsDateTimePeriod = this.getDateTimePeriod();
            DateTimePeriod rhsDateTimePeriod;
            rhsDateTimePeriod = that.getDateTimePeriod();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dateTimePeriod", lhsDateTimePeriod), LocatorUtils.property(thatLocator, "dateTimePeriod", rhsDateTimePeriod), lhsDateTimePeriod, rhsDateTimePeriod, (this.dateTimePeriod!= null), (that.dateTimePeriod!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DateTimePeriod theDateTimePeriod;
            theDateTimePeriod = this.getDateTimePeriod();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dateTimePeriod", theDateTimePeriod), currentHashCode, theDateTimePeriod, (this.dateTimePeriod!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            DateTimePeriod theDateTimePeriod;
            theDateTimePeriod = this.getDateTimePeriod();
            strategy.appendField(locator, this, "dateTimePeriod", buffer, theDateTimePeriod, (this.dateTimePeriod!= null));
        }
        {
            TransportEvent theTransportEvent;
            theTransportEvent = this.getTransportEvent();
