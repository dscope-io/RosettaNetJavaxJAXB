...
public class BusinessActionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BusinessActionType that = ((BusinessActionType) object);
        {
            BusinessActionContentType lhsValue;
            lhsValue = this.getValue();
            BusinessActionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            BusinessActionContentType theValue;
