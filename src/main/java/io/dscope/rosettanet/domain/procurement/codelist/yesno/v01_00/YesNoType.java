...
public class YesNoType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final YesNoType that = ((YesNoType) object);
        {
            YesNoContentType lhsValue;
            lhsValue = this.getValue();
            YesNoContentType rhsValue;
