...
public class QuoteStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuoteStatusType that = ((QuoteStatusType) object);
        {
            QuoteStatusContentType lhsValue;
            lhsValue = this.getValue();
            QuoteStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QuoteStatusContentType theValue;
