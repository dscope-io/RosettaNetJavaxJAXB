...
public class InventoryTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InventoryTypeType that = ((InventoryTypeType) object);
        {
            InventoryTypeContentType lhsValue;
            lhsValue = this.getValue();
            InventoryTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InventoryTypeContentType theValue;
