...
public class OrderAdminType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OrderAdminType that = ((OrderAdminType) object);
        {
            OrderAdminContentType lhsValue;
            lhsValue = this.getValue();
            OrderAdminContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            OrderAdminContentType theValue;
