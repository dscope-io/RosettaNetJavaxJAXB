...
public class ProductSubstitutionReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductSubstitutionReasonType that = ((ProductSubstitutionReasonType) object);
        {
            ProductSubstitutionReasonContentType lhsValue;
            lhsValue = this.getValue();
            ProductSubstitutionReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductSubstitutionReasonContentType theValue;
