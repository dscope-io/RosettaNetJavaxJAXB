...
public class PurchaseOrderStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PurchaseOrderStatusType that = ((PurchaseOrderStatusType) object);
        {
            PurchaseOrderStatusContentType lhsValue;
            lhsValue = this.getValue();
            PurchaseOrderStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PurchaseOrderStatusContentType theValue;
