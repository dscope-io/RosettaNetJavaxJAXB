...
public class ProductMassType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductMassType that = ((ProductMassType) object);
        {
            List<Mass> lhsMass;
        ...
        {
            String lhsUnitVolume;
            lhsUnitVolume = this.getUnitVolume();
            String rhsUnitVolume;
            rhsUnitVolume = that.getUnitVolume();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unitVolume", lhsUnitVolume), LocatorUtils.property(thatLocator, "unitVolume", rhsUnitVolume), lhsUnitVolume, rhsUnitVolume, (this.unitVolume!= null), (that.unitVolume!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theUnitVolume;
            theUnitVolume = this.getUnitVolume();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unitVolume", theUnitVolume), currentHashCode, theUnitVolume, (this.unitVolume!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theUnitVolume;
            theUnitVolume = this.getUnitVolume();
            strategy.appendField(locator, this, "unitVolume", buffer, theUnitVolume, (this.unitVolume!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
