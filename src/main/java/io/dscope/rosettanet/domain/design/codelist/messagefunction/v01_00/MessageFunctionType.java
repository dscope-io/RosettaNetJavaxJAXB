...
public class MessageFunctionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MessageFunctionType that = ((MessageFunctionType) object);
        {
            MessageFunctionContentType lhsValue;
            lhsValue = this.getValue();
            MessageFunctionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            MessageFunctionContentType theValue;
