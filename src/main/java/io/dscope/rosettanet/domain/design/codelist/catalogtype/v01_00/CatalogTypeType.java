...
public class CatalogTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CatalogTypeType that = ((CatalogTypeType) object);
        {
            CatalogTypeContentType lhsValue;
            lhsValue = this.getValue();
            CatalogTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CatalogTypeContentType theValue;
