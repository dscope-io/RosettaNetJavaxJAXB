...
public class ABCCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ABCCodeType that = ((ABCCodeType) object);
        {
            ABCCodeContentType lhsValue;
            lhsValue = this.getValue();
            ABCCodeContentType rhsValue;
