...
public class AssemblyLevelCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AssemblyLevelCodeType that = ((AssemblyLevelCodeType) object);
        {
            AssemblyLevelCodeContentType lhsValue;
            lhsValue = this.getValue();
            AssemblyLevelCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            AssemblyLevelCodeContentType theValue;
