...
public class CompliantType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompliantType that = ((CompliantType) object);
        {
            CompliantContentType lhsValue;
            lhsValue = this.getValue();
            CompliantContentType rhsValue;
