...
public class ActionCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ActionCodeType that = ((ActionCodeType) object);
        {
            ActionCodeContentType lhsValue;
            lhsValue = this.getValue();
            ActionCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ActionCodeContentType theValue;
