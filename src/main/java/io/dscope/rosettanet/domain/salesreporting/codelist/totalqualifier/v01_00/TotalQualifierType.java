...
public class TotalQualifierType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TotalQualifierType that = ((TotalQualifierType) object);
        {
            TotalQualifierContentType lhsValue;
            lhsValue = this.getValue();
            TotalQualifierContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TotalQualifierContentType theValue;
