...
public class SalesOutAndTransactionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BookPriceType lhsBookUnitPrice;
            lhsBookUnitPrice = this.getBookUnitPrice();
            BookPriceType rhsBookUnitPrice;
            rhsBookUnitPrice = that.getBookUnitPrice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bookUnitPrice", lhsBookUnitPrice), LocatorUtils.property(thatLocator, "bookUnitPrice", rhsBookUnitPrice), lhsBookUnitPrice, rhsBookUnitPrice, (this.bookUnitPrice!= null), (that.bookUnitPrice!= null))) {
                return false;
            }
        }
        {
        ...
        {
            PurchaseMethodType lhsPurchaseMethod;
            lhsPurchaseMethod = this.getPurchaseMethod();
            PurchaseMethodType rhsPurchaseMethod;
        ...
        {
            TransactionTypeType lhsTransactionType;
            lhsTransactionType = this.getTransactionType();
            TransactionTypeType rhsTransactionType;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            BookPriceType theBookUnitPrice;
            theBookUnitPrice = this.getBookUnitPrice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bookUnitPrice", theBookUnitPrice), currentHashCode, theBookUnitPrice, (this.bookUnitPrice!= null));
        }
        {
        ...
        {
            PurchaseMethodType thePurchaseMethod;
        ...
        {
            TransactionTypeType theTransactionType;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            BookPriceType theBookUnitPrice;
            theBookUnitPrice = this.getBookUnitPrice();
            strategy.appendField(locator, this, "bookUnitPrice", buffer, theBookUnitPrice, (this.bookUnitPrice!= null));
        }
        {
            String theLeaseDescription;
            theLeaseDescription = this.getLeaseDescription();
