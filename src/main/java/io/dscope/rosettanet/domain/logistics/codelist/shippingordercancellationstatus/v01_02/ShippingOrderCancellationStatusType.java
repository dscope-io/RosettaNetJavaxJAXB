...
public class ShippingOrderCancellationStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShippingOrderCancellationStatusType that = ((ShippingOrderCancellationStatusType) object);
        {
            ShippingOrderCancellationStatusContentType lhsValue;
            lhsValue = this.getValue();
            ShippingOrderCancellationStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShippingOrderCancellationStatusContentType theValue;
