...
public class InstructionTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InstructionTypeType that = ((InstructionTypeType) object);
        {
            InstructionTypeContentType lhsValue;
            lhsValue = this.getValue();
            InstructionTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InstructionTypeContentType theValue;
