...
public class ShipmentChangeDispositionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentChangeDispositionType that = ((ShipmentChangeDispositionType) object);
        {
            ShipmentChangeDispositionContentType lhsValue;
            lhsValue = this.getValue();
            ShipmentChangeDispositionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentChangeDispositionContentType theValue;
