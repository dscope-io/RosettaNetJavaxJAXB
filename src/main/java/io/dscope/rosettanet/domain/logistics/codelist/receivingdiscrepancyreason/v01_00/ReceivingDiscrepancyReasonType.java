...
public class ReceivingDiscrepancyReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReceivingDiscrepancyReasonType that = ((ReceivingDiscrepancyReasonType) object);
        {
            ReceivingDiscrepancyReasonContentType lhsValue;
            lhsValue = this.getValue();
            ReceivingDiscrepancyReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReceivingDiscrepancyReasonContentType theValue;
