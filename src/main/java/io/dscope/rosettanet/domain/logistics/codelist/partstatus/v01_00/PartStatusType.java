...
public class PartStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PartStatusType that = ((PartStatusType) object);
        {
            PartStatusContentType lhsValue;
            lhsValue = this.getValue();
            PartStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PartStatusContentType theValue;
