...
public class ShipmentModeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentModeType that = ((ShipmentModeType) object);
        {
            ShipmentModeContentType lhsValue;
            lhsValue = this.getValue();
            ShipmentModeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentModeContentType theValue;
