...
public class RouteLocationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RouteLocationType that = ((RouteLocationType) object);
        {
            RouteLocationContentType lhsValue;
            lhsValue = this.getValue();
            RouteLocationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RouteLocationContentType theValue;
