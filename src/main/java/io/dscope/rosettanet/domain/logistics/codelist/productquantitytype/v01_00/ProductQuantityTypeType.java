...
public class ProductQuantityTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductQuantityTypeType that = ((ProductQuantityTypeType) object);
        {
            ProductQuantityTypeContentType lhsValue;
            lhsValue = this.getValue();
            ProductQuantityTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductQuantityTypeContentType theValue;
