...
public class ProofOfDeliveryInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerDescriptionType lhsReceivedBy;
            lhsReceivedBy = this.getReceivedBy();
            SpecifiedPartnerDescriptionType rhsReceivedBy;
            rhsReceivedBy = that.getReceivedBy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "receivedBy", lhsReceivedBy), LocatorUtils.property(thatLocator, "receivedBy", rhsReceivedBy), lhsReceivedBy, rhsReceivedBy, (this.receivedBy!= null), (that.receivedBy!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecifiedPartnerDescriptionType theReceivedBy;
            theReceivedBy = this.getReceivedBy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "receivedBy", theReceivedBy), currentHashCode, theReceivedBy, (this.receivedBy!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SpecifiedPartnerDescriptionType theReceivedBy;
            theReceivedBy = this.getReceivedBy();
            strategy.appendField(locator, this, "receivedBy", buffer, theReceivedBy, (this.receivedBy!= null));
        }
        {
            BigInteger theTotalContainer;
            theTotalContainer = this.getTotalContainer();
