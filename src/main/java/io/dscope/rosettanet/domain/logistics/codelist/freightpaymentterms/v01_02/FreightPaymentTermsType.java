...
public class FreightPaymentTermsType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FreightPaymentTermsType that = ((FreightPaymentTermsType) object);
        {
            FreightPaymentTermsContentType lhsValue;
            lhsValue = this.getValue();
            FreightPaymentTermsContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FreightPaymentTermsContentType theValue;
