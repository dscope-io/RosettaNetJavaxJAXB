...
public class ShippingOrderStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShippingOrderStatusType that = ((ShippingOrderStatusType) object);
        {
            ShippingOrderStatusContentType lhsValue;
            lhsValue = this.getValue();
            ShippingOrderStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShippingOrderStatusContentType theValue;
