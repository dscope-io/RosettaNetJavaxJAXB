...
public class ShippingOrderRejectReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShippingOrderRejectReasonType that = ((ShippingOrderRejectReasonType) object);
        {
            ShippingOrderRejectReasonContentType lhsValue;
            lhsValue = this.getValue();
            ShippingOrderRejectReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShippingOrderRejectReasonContentType theValue;
