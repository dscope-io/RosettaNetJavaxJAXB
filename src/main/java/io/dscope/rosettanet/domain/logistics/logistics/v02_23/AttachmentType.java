 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:01.02}MimeTypeQualifier" minOccurs="0"/&gt;
...
public class AttachmentType implements Equals2, HashCode2, ToString2
{
    ...
    @XmlElementRef(name = "MimeTypeQualifier", namespace = "urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:01.02", type = MimeTypeQualifier.class, required = false)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsDescriptionCode;
            lhsDescriptionCode = this.getDescriptionCode();
            String rhsDescriptionCode;
