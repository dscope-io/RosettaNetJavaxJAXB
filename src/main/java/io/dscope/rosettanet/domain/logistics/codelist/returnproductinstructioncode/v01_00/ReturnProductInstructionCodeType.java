...
public class ReturnProductInstructionCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReturnProductInstructionCodeType that = ((ReturnProductInstructionCodeType) object);
        {
            ReturnProductInstructionCodeContentType lhsValue;
            lhsValue = this.getValue();
            ReturnProductInstructionCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReturnProductInstructionCodeContentType theValue;
