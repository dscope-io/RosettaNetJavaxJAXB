...
public class IncotermsType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IncotermsType that = ((IncotermsType) object);
        {
            IncotermsContentType lhsValue;
            lhsValue = this.getValue();
            IncotermsContentType rhsValue;
