...
public class LinearWithMeasureTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LinearWithMeasureTypeType that = ((LinearWithMeasureTypeType) object);
        {
            MeasureWithTypeType lhsHeight;
            lhsHeight = this.getHeight();
            MeasureWithTypeType rhsHeight;
        ...
        {
            MeasureWithTypeType lhsLength;
            lhsLength = this.getLength();
            MeasureWithTypeType rhsLength;
        ...
        {
            MeasureWithTypeType lhsWidth;
            lhsWidth = this.getWidth();
            MeasureWithTypeType rhsWidth;
