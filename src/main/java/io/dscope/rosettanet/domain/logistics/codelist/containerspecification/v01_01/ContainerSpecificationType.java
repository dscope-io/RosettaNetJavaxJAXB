...
public class ContainerSpecificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContainerSpecificationType that = ((ContainerSpecificationType) object);
        {
            ContainerSpecificationContentType lhsValue;
            lhsValue = this.getValue();
            ContainerSpecificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ContainerSpecificationContentType theValue;
