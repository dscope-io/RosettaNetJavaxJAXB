...
public class NationalExportControlClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NationalExportControlClassificationType that = ((NationalExportControlClassificationType) object);
        {
            NationalExportControlClassificationContentType lhsValue;
            lhsValue = this.getValue();
            NationalExportControlClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            NationalExportControlClassificationContentType theValue;
