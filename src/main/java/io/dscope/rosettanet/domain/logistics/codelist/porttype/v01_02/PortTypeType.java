...
public class PortTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PortTypeType that = ((PortTypeType) object);
        {
            PortTypeContentType lhsValue;
            lhsValue = this.getValue();
            PortTypeContentType rhsValue;
