...
public class PortIdentifierAuthorityCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PortIdentifierAuthorityCodeType that = ((PortIdentifierAuthorityCodeType) object);
        {
            PortIdentifierAuthorityCodeContentType lhsValue;
            lhsValue = this.getValue();
            PortIdentifierAuthorityCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PortIdentifierAuthorityCodeContentType theValue;
