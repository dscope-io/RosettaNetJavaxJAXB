...
public class ReturnLabelCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReturnLabelCodeType that = ((ReturnLabelCodeType) object);
        {
            ReturnLabelCodeContentType lhsValue;
            lhsValue = this.getValue();
            ReturnLabelCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReturnLabelCodeContentType theValue;
