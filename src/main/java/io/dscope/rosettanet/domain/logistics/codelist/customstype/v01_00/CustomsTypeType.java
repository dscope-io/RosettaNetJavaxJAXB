...
public class CustomsTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CustomsTypeType that = ((CustomsTypeType) object);
        {
            CustomsTypeContentType lhsValue;
            lhsValue = this.getValue();
            CustomsTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CustomsTypeContentType theValue;
