...
public class ReceivingDiscrepancyType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReceivingDiscrepancyType that = ((ReceivingDiscrepancyType) object);
        {
            ReceivingDiscrepancyContentType lhsValue;
            lhsValue = this.getValue();
            ReceivingDiscrepancyContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReceivingDiscrepancyContentType theValue;
