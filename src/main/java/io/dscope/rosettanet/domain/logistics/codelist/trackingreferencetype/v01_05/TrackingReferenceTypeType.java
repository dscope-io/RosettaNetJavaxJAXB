...
public class TrackingReferenceTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TrackingReferenceTypeType that = ((TrackingReferenceTypeType) object);
        {
            TrackingReferenceTypeContentType lhsValue;
            lhsValue = this.getValue();
            TrackingReferenceTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TrackingReferenceTypeContentType theValue;
