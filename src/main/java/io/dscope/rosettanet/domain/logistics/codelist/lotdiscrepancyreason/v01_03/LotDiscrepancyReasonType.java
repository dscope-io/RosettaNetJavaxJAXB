...
public class LotDiscrepancyReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LotDiscrepancyReasonType that = ((LotDiscrepancyReasonType) object);
        {
            LotDiscrepancyReasonContentType lhsValue;
            lhsValue = this.getValue();
            LotDiscrepancyReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LotDiscrepancyReasonContentType theValue;
