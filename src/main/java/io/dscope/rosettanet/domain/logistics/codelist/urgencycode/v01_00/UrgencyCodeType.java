...
public class UrgencyCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final UrgencyCodeType that = ((UrgencyCodeType) object);
        {
            UrgencyCodeContentType lhsValue;
            lhsValue = this.getValue();
            UrgencyCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            UrgencyCodeContentType theValue;
