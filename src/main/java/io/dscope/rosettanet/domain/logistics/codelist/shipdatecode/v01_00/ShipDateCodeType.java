...
public class ShipDateCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipDateCodeType that = ((ShipDateCodeType) object);
        {
            ShipDateCodeContentType lhsValue;
            lhsValue = this.getValue();
            ShipDateCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipDateCodeContentType theValue;
