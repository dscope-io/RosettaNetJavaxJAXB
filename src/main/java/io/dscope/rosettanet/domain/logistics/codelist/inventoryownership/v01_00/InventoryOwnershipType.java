...
public class InventoryOwnershipType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InventoryOwnershipType that = ((InventoryOwnershipType) object);
        {
            InventoryOwnershipContentType lhsValue;
            lhsValue = this.getValue();
            InventoryOwnershipContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InventoryOwnershipContentType theValue;
