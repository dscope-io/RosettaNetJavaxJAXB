...
public class MarkUpTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MarkUpTypeType that = ((MarkUpTypeType) object);
        {
            MarkUpTypeContentType lhsValue;
            lhsValue = this.getValue();
            MarkUpTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            MarkUpTypeContentType theValue;
