...
public class ShippingDocumentType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShippingDocumentType that = ((ShippingDocumentType) object);
        {
            ShippingDocumentContentType lhsValue;
            lhsValue = this.getValue();
            ShippingDocumentContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShippingDocumentContentType theValue;
