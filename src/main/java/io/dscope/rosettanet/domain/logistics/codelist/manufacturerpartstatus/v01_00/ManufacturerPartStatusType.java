...
public class ManufacturerPartStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ManufacturerPartStatusType that = ((ManufacturerPartStatusType) object);
        {
            ManufacturerPartStatusContentType lhsValue;
            lhsValue = this.getValue();
            ManufacturerPartStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ManufacturerPartStatusContentType theValue;
