...
public class ContainerTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContainerTypeType that = ((ContainerTypeType) object);
        {
            ContainerTypeContentType lhsValue;
            lhsValue = this.getValue();
            ContainerTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ContainerTypeContentType theValue;
