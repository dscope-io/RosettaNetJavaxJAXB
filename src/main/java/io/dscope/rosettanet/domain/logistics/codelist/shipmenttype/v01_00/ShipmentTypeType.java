...
public class ShipmentTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShipmentTypeType that = ((ShipmentTypeType) object);
        {
            ShipmentTypeContentType lhsValue;
            lhsValue = this.getValue();
            ShipmentTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ShipmentTypeContentType theValue;
