...
public class OriginatingPartnerType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OriginatingPartnerType that = ((OriginatingPartnerType) object);
        {
            PartnerDescriptionType lhsShipFrom;
            lhsShipFrom = this.getShipFrom();
            PartnerDescriptionType rhsShipFrom;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PartnerDescriptionType theShipFrom;
