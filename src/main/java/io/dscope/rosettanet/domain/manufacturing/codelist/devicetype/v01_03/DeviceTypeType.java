...
public class DeviceTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DeviceTypeType that = ((DeviceTypeType) object);
        {
            DeviceTypeContentType lhsValue;
            lhsValue = this.getValue();
            DeviceTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DeviceTypeContentType theValue;
