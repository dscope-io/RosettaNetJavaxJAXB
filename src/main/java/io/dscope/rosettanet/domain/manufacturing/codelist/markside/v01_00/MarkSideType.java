...
public class MarkSideType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MarkSideType that = ((MarkSideType) object);
        {
            MarkSideContentType lhsValue;
            lhsValue = this.getValue();
            MarkSideContentType rhsValue;
