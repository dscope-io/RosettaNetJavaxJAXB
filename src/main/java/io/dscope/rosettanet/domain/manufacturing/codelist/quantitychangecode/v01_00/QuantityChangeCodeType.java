...
public class QuantityChangeCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuantityChangeCodeType that = ((QuantityChangeCodeType) object);
        {
            QuantityChangeCodeContentType lhsValue;
            lhsValue = this.getValue();
            QuantityChangeCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QuantityChangeCodeContentType theValue;
