...
public class OrderReferenceType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BigDecimal lhsWorkOrderCompleted;
            lhsWorkOrderCompleted = this.getWorkOrderCompleted();
            BigDecimal rhsWorkOrderCompleted;
            rhsWorkOrderCompleted = that.getWorkOrderCompleted();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "workOrderCompleted", lhsWorkOrderCompleted), LocatorUtils.property(thatLocator, "workOrderCompleted", rhsWorkOrderCompleted), lhsWorkOrderCompleted, rhsWorkOrderCompleted, (this.workOrderCompleted!= null), (that.workOrderCompleted!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            BigDecimal theWorkOrderCompleted;
            theWorkOrderCompleted = this.getWorkOrderCompleted();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "workOrderCompleted", theWorkOrderCompleted), currentHashCode, theWorkOrderCompleted, (this.workOrderCompleted!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            BigDecimal theWorkOrderCompleted;
            theWorkOrderCompleted = this.getWorkOrderCompleted();
            strategy.appendField(locator, this, "workOrderCompleted", buffer, theWorkOrderCompleted, (this.workOrderCompleted!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
