...
public class CompletionStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompletionStatusType that = ((CompletionStatusType) object);
        {
            CompletionStatusContentType lhsValue;
            lhsValue = this.getValue();
            CompletionStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CompletionStatusContentType theValue;
