...
public class TestMapType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            WaferCoordinate lhsWaferCoordinate;
            lhsWaferCoordinate = this.getWaferCoordinate();
            WaferCoordinate rhsWaferCoordinate;
            rhsWaferCoordinate = that.getWaferCoordinate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "waferCoordinate", lhsWaferCoordinate), LocatorUtils.property(thatLocator, "waferCoordinate", rhsWaferCoordinate), lhsWaferCoordinate, rhsWaferCoordinate, (this.waferCoordinate!= null), (that.waferCoordinate!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WaferCoordinate theWaferCoordinate;
            theWaferCoordinate = this.getWaferCoordinate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "waferCoordinate", theWaferCoordinate), currentHashCode, theWaferCoordinate, (this.waferCoordinate!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            WaferCoordinate theWaferCoordinate;
            theWaferCoordinate = this.getWaferCoordinate();
            strategy.appendField(locator, this, "waferCoordinate", buffer, theWaferCoordinate, (this.waferCoordinate!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
