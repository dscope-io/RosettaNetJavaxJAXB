...
public class TestSetupType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsCustomerTestProgramEC;
            lhsCustomerTestProgramEC = this.getCustomerTestProgramEC();
            String rhsCustomerTestProgramEC;
            rhsCustomerTestProgramEC = that.getCustomerTestProgramEC();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customerTestProgramEC", lhsCustomerTestProgramEC), LocatorUtils.property(thatLocator, "customerTestProgramEC", rhsCustomerTestProgramEC), lhsCustomerTestProgramEC, rhsCustomerTestProgramEC, (this.customerTestProgramEC!= null), (that.customerTestProgramEC!= null))) {
                return false;
            }
        }
        {
            String lhsCustomerTestProgramName;
            lhsCustomerTestProgramName = this.getCustomerTestProgramName();
            String rhsCustomerTestProgramName;
            rhsCustomerTestProgramName = that.getCustomerTestProgramName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customerTestProgramName", lhsCustomerTestProgramName), LocatorUtils.property(thatLocator, "customerTestProgramName", rhsCustomerTestProgramName), lhsCustomerTestProgramName, rhsCustomerTestProgramName, (this.customerTestProgramName!= null), (that.customerTestProgramName!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theCustomerTestProgramEC;
            theCustomerTestProgramEC = this.getCustomerTestProgramEC();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customerTestProgramEC", theCustomerTestProgramEC), currentHashCode, theCustomerTestProgramEC, (this.customerTestProgramEC!= null));
        }
        {
            String theCustomerTestProgramName;
            theCustomerTestProgramName = this.getCustomerTestProgramName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customerTestProgramName", theCustomerTestProgramName), currentHashCode, theCustomerTestProgramName, (this.customerTestProgramName!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theCustomerTestProgramEC;
            theCustomerTestProgramEC = this.getCustomerTestProgramEC();
            strategy.appendField(locator, this, "customerTestProgramEC", buffer, theCustomerTestProgramEC, (this.customerTestProgramEC!= null));
        }
        {
            String theCustomerTestProgramName;
            theCustomerTestProgramName = this.getCustomerTestProgramName();
            strategy.appendField(locator, this, "customerTestProgramName", buffer, theCustomerTestProgramName, (this.customerTestProgramName!= null));
        }
        {
            BigInteger thePrimaryIdentifier;
            thePrimaryIdentifier = this.getPrimaryIdentifier();
