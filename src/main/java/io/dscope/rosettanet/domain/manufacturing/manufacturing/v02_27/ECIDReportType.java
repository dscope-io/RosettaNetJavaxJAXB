...
public class ECIDReportType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsECIDType;
            lhsECIDType = this.getECIDType();
            String rhsECIDType;
            rhsECIDType = that.getECIDType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ecidType", lhsECIDType), LocatorUtils.property(thatLocator, "ecidType", rhsECIDType), lhsECIDType, rhsECIDType, (this.ecidType!= null), (that.ecidType!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theECIDType;
            theECIDType = this.getECIDType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ecidType", theECIDType), currentHashCode, theECIDType, (this.ecidType!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theECIDType;
            theECIDType = this.getECIDType();
            strategy.appendField(locator, this, "ecidType", buffer, theECIDType, (this.ecidType!= null));
        }
        {
            IntCoordinate theIntCoordinate;
            theIntCoordinate = this.getIntCoordinate();
