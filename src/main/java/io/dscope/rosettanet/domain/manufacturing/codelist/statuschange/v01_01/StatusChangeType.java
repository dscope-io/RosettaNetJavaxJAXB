...
public class StatusChangeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final StatusChangeType that = ((StatusChangeType) object);
        {
            StatusChangeContentType lhsValue;
            lhsValue = this.getValue();
            StatusChangeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            StatusChangeContentType theValue;
