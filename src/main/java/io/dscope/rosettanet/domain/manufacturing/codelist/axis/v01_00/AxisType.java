...
public class AxisType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AxisType that = ((AxisType) object);
        {
            AxisContentType lhsValue;
            lhsValue = this.getValue();
            AxisContentType rhsValue;
