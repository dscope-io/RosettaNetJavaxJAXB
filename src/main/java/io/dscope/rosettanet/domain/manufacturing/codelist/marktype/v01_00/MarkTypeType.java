...
public class MarkTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MarkTypeType that = ((MarkTypeType) object);
        {
            MarkTypeContentType lhsValue;
            lhsValue = this.getValue();
            MarkTypeContentType rhsValue;
