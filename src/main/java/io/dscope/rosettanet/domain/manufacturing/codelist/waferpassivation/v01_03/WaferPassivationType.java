...
public class WaferPassivationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WaferPassivationType that = ((WaferPassivationType) object);
        {
            WaferPassivationContentType lhsValue;
            lhsValue = this.getValue();
            WaferPassivationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WaferPassivationContentType theValue;
