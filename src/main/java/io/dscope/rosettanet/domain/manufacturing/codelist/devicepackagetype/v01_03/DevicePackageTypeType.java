...
public class DevicePackageTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DevicePackageTypeType that = ((DevicePackageTypeType) object);
        {
            DevicePackageTypeContentType lhsValue;
            lhsValue = this.getValue();
            DevicePackageTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DevicePackageTypeContentType theValue;
