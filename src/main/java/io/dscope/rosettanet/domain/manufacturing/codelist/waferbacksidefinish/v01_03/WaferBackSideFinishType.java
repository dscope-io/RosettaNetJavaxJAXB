...
public class WaferBackSideFinishType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WaferBackSideFinishType that = ((WaferBackSideFinishType) object);
        {
            WaferBackSideFinishContentType lhsValue;
            lhsValue = this.getValue();
            WaferBackSideFinishContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WaferBackSideFinishContentType theValue;
