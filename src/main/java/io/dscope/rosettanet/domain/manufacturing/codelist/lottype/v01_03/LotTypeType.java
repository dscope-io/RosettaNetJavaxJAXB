...
public class LotTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LotTypeType that = ((LotTypeType) object);
        {
            LotTypeContentType lhsValue;
            lhsValue = this.getValue();
            LotTypeContentType rhsValue;
