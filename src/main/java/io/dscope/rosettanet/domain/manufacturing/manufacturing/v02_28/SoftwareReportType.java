...
public class SoftwareReportType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SoftwareReportType that = ((SoftwareReportType) object);
        {
            String lhsBuildID;
            lhsBuildID = this.getBuildID();
            String rhsBuildID;
            rhsBuildID = that.getBuildID();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "buildID", lhsBuildID), LocatorUtils.property(thatLocator, "buildID", rhsBuildID), lhsBuildID, rhsBuildID, (this.buildID!= null), (that.buildID!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theBuildID;
            theBuildID = this.getBuildID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "buildID", theBuildID), currentHashCode, theBuildID, (this.buildID!= null));
        }
        {
            String theName;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theBuildID;
            theBuildID = this.getBuildID();
            strategy.appendField(locator, this, "buildID", buffer, theBuildID, (this.buildID!= null));
        }
        {
            String theName;
            theName = this.getName();
