...
public class SpecialInstructionCategoryType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SpecialInstructionCategoryType that = ((SpecialInstructionCategoryType) object);
        {
            SpecialInstructionCategoryContentType lhsValue;
            lhsValue = this.getValue();
            SpecialInstructionCategoryContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SpecialInstructionCategoryContentType theValue;
