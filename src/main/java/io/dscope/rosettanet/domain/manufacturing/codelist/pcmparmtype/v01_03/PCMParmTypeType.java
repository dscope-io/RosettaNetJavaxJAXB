...
public class PCMParmTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PCMParmTypeType that = ((PCMParmTypeType) object);
        {
            PCMParmTypeContentType lhsValue;
            lhsValue = this.getValue();
            PCMParmTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PCMParmTypeContentType theValue;
