...
public class AttachmentDescriptionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AttachmentDescriptionType that = ((AttachmentDescriptionType) object);
        {
            AttachmentDescriptionContentType lhsValue;
            lhsValue = this.getValue();
            AttachmentDescriptionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            AttachmentDescriptionContentType theValue;
