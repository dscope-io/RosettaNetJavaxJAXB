...
public class RawWaferTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RawWaferTypeType that = ((RawWaferTypeType) object);
        {
            RawWaferTypeContentType lhsValue;
            lhsValue = this.getValue();
            RawWaferTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RawWaferTypeContentType theValue;
