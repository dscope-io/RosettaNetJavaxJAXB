...
public class WorkInProcessTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WorkInProcessTypeType that = ((WorkInProcessTypeType) object);
        {
            WorkInProcessTypeContentType lhsValue;
            lhsValue = this.getValue();
            WorkInProcessTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WorkInProcessTypeContentType theValue;
