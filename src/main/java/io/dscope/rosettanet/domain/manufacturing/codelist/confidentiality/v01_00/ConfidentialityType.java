...
public class ConfidentialityType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConfidentialityType that = ((ConfidentialityType) object);
        {
            ConfidentialityContentType lhsValue;
            lhsValue = this.getValue();
            ConfidentialityContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ConfidentialityContentType theValue;
