...
public class TestResultType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TestResultType that = ((TestResultType) object);
        {
            TestResultContentType lhsValue;
            lhsValue = this.getValue();
            TestResultContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TestResultContentType theValue;
