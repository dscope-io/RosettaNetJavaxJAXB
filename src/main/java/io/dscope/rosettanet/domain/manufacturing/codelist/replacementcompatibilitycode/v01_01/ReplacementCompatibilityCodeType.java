...
public class ReplacementCompatibilityCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReplacementCompatibilityCodeType that = ((ReplacementCompatibilityCodeType) object);
        {
            ReplacementCompatibilityCodeContentType lhsValue;
            lhsValue = this.getValue();
            ReplacementCompatibilityCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReplacementCompatibilityCodeContentType theValue;
