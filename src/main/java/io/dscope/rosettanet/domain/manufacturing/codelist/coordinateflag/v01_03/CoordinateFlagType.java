...
public class CoordinateFlagType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CoordinateFlagType that = ((CoordinateFlagType) object);
        {
            CoordinateFlagContentType lhsValue;
            lhsValue = this.getValue();
            CoordinateFlagContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CoordinateFlagContentType theValue;
