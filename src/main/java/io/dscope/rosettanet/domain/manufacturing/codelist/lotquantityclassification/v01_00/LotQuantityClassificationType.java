...
public class LotQuantityClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LotQuantityClassificationType that = ((LotQuantityClassificationType) object);
        {
            LotQuantityClassificationContentType lhsValue;
            lhsValue = this.getValue();
            LotQuantityClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            LotQuantityClassificationContentType theValue;
