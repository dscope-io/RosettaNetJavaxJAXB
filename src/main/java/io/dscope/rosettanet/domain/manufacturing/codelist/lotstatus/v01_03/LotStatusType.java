...
public class LotStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LotStatusType that = ((LotStatusType) object);
        {
            LotStatusContentType lhsValue;
            lhsValue = this.getValue();
            LotStatusContentType rhsValue;
