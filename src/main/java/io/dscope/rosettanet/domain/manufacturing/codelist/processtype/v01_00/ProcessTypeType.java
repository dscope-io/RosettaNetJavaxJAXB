...
public class ProcessTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProcessTypeType that = ((ProcessTypeType) object);
        {
            ProcessTypeContentType lhsValue;
            lhsValue = this.getValue();
            ProcessTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProcessTypeContentType theValue;
