...
public class ComponentTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ComponentTypeType that = ((ComponentTypeType) object);
        {
            ComponentTypeContentType lhsValue;
            lhsValue = this.getValue();
            ComponentTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ComponentTypeContentType theValue;
