...
public class PriorityType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PriorityType that = ((PriorityType) object);
        {
            PriorityContentType lhsValue;
            lhsValue = this.getValue();
            PriorityContentType rhsValue;
