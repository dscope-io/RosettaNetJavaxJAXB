...
public class WorkInProcessPartTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WorkInProcessPartTypeType that = ((WorkInProcessPartTypeType) object);
        {
            WorkInProcessPartTypeContentType lhsValue;
            lhsValue = this.getValue();
            WorkInProcessPartTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WorkInProcessPartTypeContentType theValue;
