...
public class WaferType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsShortID;
            lhsShortID = this.getShortID();
            String rhsShortID;
            rhsShortID = that.getShortID();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "shortID", lhsShortID), LocatorUtils.property(thatLocator, "shortID", rhsShortID), lhsShortID, rhsShortID, (this.shortID!= null), (that.shortID!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theShortID;
            theShortID = this.getShortID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "shortID", theShortID), currentHashCode, theShortID, (this.shortID!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theShortID;
            theShortID = this.getShortID();
            strategy.appendField(locator, this, "shortID", buffer, theShortID, (this.shortID!= null));
        }
        {
            String theWaferUniqueID;
            theWaferUniqueID = this.getWaferUniqueID();
