...
public class WaferQualityRatingType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WaferQualityRatingType that = ((WaferQualityRatingType) object);
        {
            WaferQualityRatingContentType lhsValue;
            lhsValue = this.getValue();
            WaferQualityRatingContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WaferQualityRatingContentType theValue;
