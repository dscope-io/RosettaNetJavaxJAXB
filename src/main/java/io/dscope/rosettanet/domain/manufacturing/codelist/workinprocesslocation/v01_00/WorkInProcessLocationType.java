...
public class WorkInProcessLocationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WorkInProcessLocationType that = ((WorkInProcessLocationType) object);
        {
            WorkInProcessLocationContentType lhsValue;
            lhsValue = this.getValue();
            WorkInProcessLocationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WorkInProcessLocationContentType theValue;
