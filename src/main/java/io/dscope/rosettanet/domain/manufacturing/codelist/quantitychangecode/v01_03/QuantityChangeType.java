...
public class QuantityChangeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QuantityChangeType that = ((QuantityChangeType) object);
        {
            QuantityChangeContentType lhsValue;
            lhsValue = this.getValue();
            QuantityChangeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QuantityChangeContentType theValue;
