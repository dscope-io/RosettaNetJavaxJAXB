...
public class EquipmentTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EquipmentTypeType that = ((EquipmentTypeType) object);
        {
            EquipmentTypeContentType lhsValue;
            lhsValue = this.getValue();
            EquipmentTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            EquipmentTypeContentType theValue;
