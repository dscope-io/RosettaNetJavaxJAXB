...
public class ChangeReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ChangeReasonType that = ((ChangeReasonType) object);
        {
            ChangeReasonContentType lhsValue;
            lhsValue = this.getValue();
            ChangeReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ChangeReasonContentType theValue;
