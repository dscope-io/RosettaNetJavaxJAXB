...
public class ProjectMarketSegmentType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProjectMarketSegmentType that = ((ProjectMarketSegmentType) object);
        {
            ProjectMarketSegmentContentType lhsValue;
            lhsValue = this.getValue();
            ProjectMarketSegmentContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProjectMarketSegmentContentType theValue;
