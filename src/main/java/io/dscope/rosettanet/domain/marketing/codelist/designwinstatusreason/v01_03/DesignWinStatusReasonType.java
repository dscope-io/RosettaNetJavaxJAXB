...
public class DesignWinStatusReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DesignWinStatusReasonType that = ((DesignWinStatusReasonType) object);
        {
            DesignWinStatusReasonContentType lhsValue;
            lhsValue = this.getValue();
            DesignWinStatusReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DesignWinStatusReasonContentType theValue;
