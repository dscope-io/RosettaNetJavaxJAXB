...
public class GeographicRegionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            GeographicRegionCode lhsGeographicRegionCode;
            lhsGeographicRegionCode = this.getGeographicRegionCode();
            GeographicRegionCode rhsGeographicRegionCode;
            rhsGeographicRegionCode = that.getGeographicRegionCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geographicRegionCode", lhsGeographicRegionCode), LocatorUtils.property(thatLocator, "geographicRegionCode", rhsGeographicRegionCode), lhsGeographicRegionCode, rhsGeographicRegionCode, (this.geographicRegionCode!= null), (that.geographicRegionCode!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            GeographicRegionCode theGeographicRegionCode;
            theGeographicRegionCode = this.getGeographicRegionCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geographicRegionCode", theGeographicRegionCode), currentHashCode, theGeographicRegionCode, (this.geographicRegionCode!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            GeographicRegionCode theGeographicRegionCode;
            theGeographicRegionCode = this.getGeographicRegionCode();
            strategy.appendField(locator, this, "geographicRegionCode", buffer, theGeographicRegionCode, (this.geographicRegionCode!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
