...
public class CoreProductRegistrationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CoreProductRegistrationType that = ((CoreProductRegistrationType) object);
        {
        ...
        {
            List<DeviceProductRegistration> lhsDeviceProductRegistration;
            lhsDeviceProductRegistration = (((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty()))?this.getDeviceProductRegistration():null);
            List<DeviceProductRegistration> rhsDeviceProductRegistration;
            rhsDeviceProductRegistration = (((that.deviceProductRegistration!= null)&&(!that.deviceProductRegistration.isEmpty()))?that.getDeviceProductRegistration():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "deviceProductRegistration", lhsDeviceProductRegistration), LocatorUtils.property(thatLocator, "deviceProductRegistration", rhsDeviceProductRegistration), lhsDeviceProductRegistration, rhsDeviceProductRegistration, ((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty())), ((that.deviceProductRegistration!= null)&&(!that.deviceProductRegistration.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<DeviceProductRegistration> theDeviceProductRegistration;
            theDeviceProductRegistration = (((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty()))?this.getDeviceProductRegistration():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "deviceProductRegistration", theDeviceProductRegistration), currentHashCode, theDeviceProductRegistration, ((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<DeviceProductRegistration> theDeviceProductRegistration;
            theDeviceProductRegistration = (((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty()))?this.getDeviceProductRegistration():null);
            strategy.appendField(locator, this, "deviceProductRegistration", buffer, theDeviceProductRegistration, ((this.deviceProductRegistration!= null)&&(!this.deviceProductRegistration.isEmpty())));
        }
        {
            IsDeveloperToolKit theIsDeveloperToolKit;
            theIsDeveloperToolKit = this.getIsDeveloperToolKit();
