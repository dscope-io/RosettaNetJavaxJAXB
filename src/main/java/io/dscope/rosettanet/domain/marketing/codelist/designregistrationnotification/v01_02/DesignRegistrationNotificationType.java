...
public class DesignRegistrationNotificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DesignRegistrationNotificationType that = ((DesignRegistrationNotificationType) object);
        {
            DesignRegistrationNotificationContentType lhsValue;
            lhsValue = this.getValue();
            DesignRegistrationNotificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DesignRegistrationNotificationContentType theValue;
