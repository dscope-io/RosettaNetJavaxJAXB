...
public class GeographicRegionCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeographicRegionCodeType that = ((GeographicRegionCodeType) object);
        {
            GeographicRegionCodeContentType lhsValue;
            lhsValue = this.getValue();
            GeographicRegionCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            GeographicRegionCodeContentType theValue;
