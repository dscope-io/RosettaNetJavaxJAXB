...
public class RegistrationComplexityLevelType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RegistrationComplexityLevelType that = ((RegistrationComplexityLevelType) object);
        {
            RegistrationComplexityLevelContentType lhsValue;
            lhsValue = this.getValue();
            RegistrationComplexityLevelContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RegistrationComplexityLevelContentType theValue;
