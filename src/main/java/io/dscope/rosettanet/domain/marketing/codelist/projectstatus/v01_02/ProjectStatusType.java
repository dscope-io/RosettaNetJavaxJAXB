...
public class ProjectStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProjectStatusType that = ((ProjectStatusType) object);
        {
            ProjectStatusContentType lhsValue;
            lhsValue = this.getValue();
            ProjectStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProjectStatusContentType theValue;
