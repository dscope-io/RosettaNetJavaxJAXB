...
public class DesignWinClassificationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DesignWinClassificationType that = ((DesignWinClassificationType) object);
        {
            DesignWinClassificationContentType lhsValue;
            lhsValue = this.getValue();
            DesignWinClassificationContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DesignWinClassificationContentType theValue;
