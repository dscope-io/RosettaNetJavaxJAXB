...
public class RegistrationInvolvementLevelType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RegistrationInvolvementLevelType that = ((RegistrationInvolvementLevelType) object);
        {
            RegistrationInvolvementLevelContentType lhsValue;
            lhsValue = this.getValue();
            RegistrationInvolvementLevelContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RegistrationInvolvementLevelContentType theValue;
