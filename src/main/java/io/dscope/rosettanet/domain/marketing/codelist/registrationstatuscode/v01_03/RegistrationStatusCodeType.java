...
public class RegistrationStatusCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RegistrationStatusCodeType that = ((RegistrationStatusCodeType) object);
        {
            RegistrationStatusCodeContentType lhsValue;
            lhsValue = this.getValue();
            RegistrationStatusCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RegistrationStatusCodeContentType theValue;
