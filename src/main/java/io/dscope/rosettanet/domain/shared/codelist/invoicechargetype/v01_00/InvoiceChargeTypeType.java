...
public class InvoiceChargeTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InvoiceChargeTypeType that = ((InvoiceChargeTypeType) object);
        {
            InvoiceChargeTypeContentType lhsValue;
            lhsValue = this.getValue();
            InvoiceChargeTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            InvoiceChargeTypeContentType theValue;
