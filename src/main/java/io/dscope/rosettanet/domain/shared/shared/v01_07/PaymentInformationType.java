...
public class PaymentInformationType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PaymentInformationType that = ((PaymentInformationType) object);
        {
        ...
        {
            PaymentType lhsPaymentType;
            lhsPaymentType = this.getPaymentType();
            PaymentType rhsPaymentType;
