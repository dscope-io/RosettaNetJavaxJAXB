...
public class PaymentTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PaymentTypeType that = ((PaymentTypeType) object);
        {
            PaymentTypeContentType lhsValue;
            lhsValue = this.getValue();
            PaymentTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PaymentTypeContentType theValue;
