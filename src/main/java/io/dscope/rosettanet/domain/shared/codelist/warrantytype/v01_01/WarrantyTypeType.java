...
public class WarrantyTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WarrantyTypeType that = ((WarrantyTypeType) object);
        {
            WarrantyTypeContentType lhsValue;
            lhsValue = this.getValue();
            WarrantyTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WarrantyTypeContentType theValue;
