...
public class RateTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RateTypeType that = ((RateTypeType) object);
        {
            RateTypeContentType lhsValue;
            lhsValue = this.getValue();
            RateTypeContentType rhsValue;
