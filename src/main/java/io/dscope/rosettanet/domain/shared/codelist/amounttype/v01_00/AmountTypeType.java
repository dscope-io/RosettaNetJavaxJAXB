...
public class AmountTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AmountTypeType that = ((AmountTypeType) object);
        {
            AmountTypeContentType lhsValue;
            lhsValue = this.getValue();
            AmountTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            AmountTypeContentType theValue;
