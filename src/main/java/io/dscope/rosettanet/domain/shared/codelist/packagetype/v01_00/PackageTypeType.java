...
public class PackageTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PackageTypeType that = ((PackageTypeType) object);
        {
            PackageTypeContentType lhsValue;
            lhsValue = this.getValue();
            PackageTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            PackageTypeContentType theValue;
