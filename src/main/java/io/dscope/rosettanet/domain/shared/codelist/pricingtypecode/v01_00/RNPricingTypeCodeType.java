...
public class RNPricingTypeCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RNPricingTypeCodeType that = ((RNPricingTypeCodeType) object);
        {
            RNPricingTypeCodeContentType lhsValue;
            lhsValue = this.getValue();
            RNPricingTypeCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RNPricingTypeCodeContentType theValue;
