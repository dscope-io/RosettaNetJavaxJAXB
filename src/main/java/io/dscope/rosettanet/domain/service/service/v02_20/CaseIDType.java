...
public class CaseIDType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "authority", lhsAuthority), LocatorUtils.property(thatLocator, "authority", rhsAuthority), lhsAuthority, rhsAuthority, (this.authority!= null), (that.authority!= null))) {
                return false;
            }
        }
        {
            XMLGregorianCalendar lhsCaseCreationDatetimeStamp;
            lhsCaseCreationDatetimeStamp = this.getCaseCreationDatetimeStamp();
            XMLGregorianCalendar rhsCaseCreationDatetimeStamp;
            rhsCaseCreationDatetimeStamp = that.getCaseCreationDatetimeStamp();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "caseCreationDatetimeStamp", lhsCaseCreationDatetimeStamp), LocatorUtils.property(thatLocator, "caseCreationDatetimeStamp", rhsCaseCreationDatetimeStamp), lhsCaseCreationDatetimeStamp, rhsCaseCreationDatetimeStamp, (this.caseCreationDatetimeStamp!= null), (that.caseCreationDatetimeStamp!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "authority", theAuthority), currentHashCode, theAuthority, (this.authority!= null));
        }
        {
            XMLGregorianCalendar theCaseCreationDatetimeStamp;
            theCaseCreationDatetimeStamp = this.getCaseCreationDatetimeStamp();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "caseCreationDatetimeStamp", theCaseCreationDatetimeStamp), currentHashCode, theCaseCreationDatetimeStamp, (this.caseCreationDatetimeStamp!= null));
        }
        {
            List<String> theSP;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            XMLGregorianCalendar theCaseCreationDatetimeStamp;
            theCaseCreationDatetimeStamp = this.getCaseCreationDatetimeStamp();
            strategy.appendField(locator, this, "caseCreationDatetimeStamp", buffer, theCaseCreationDatetimeStamp, (this.caseCreationDatetimeStamp!= null));
        }
        {
            List<String> theSP;
            theSP = (((this.sp!= null)&&(!this.sp.isEmpty()))?this.getSP():null);
