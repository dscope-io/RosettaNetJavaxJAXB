...
public class UpdateType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CRContactType lhsUpdatedBy;
            lhsUpdatedBy = this.getUpdatedBy();
            CRContactType rhsUpdatedBy;
            rhsUpdatedBy = that.getUpdatedBy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "updatedBy", lhsUpdatedBy), LocatorUtils.property(thatLocator, "updatedBy", rhsUpdatedBy), lhsUpdatedBy, rhsUpdatedBy, (this.updatedBy!= null), (that.updatedBy!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            CRContactType theUpdatedBy;
            theUpdatedBy = this.getUpdatedBy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "updatedBy", theUpdatedBy), currentHashCode, theUpdatedBy, (this.updatedBy!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            CRContactType theUpdatedBy;
            theUpdatedBy = this.getUpdatedBy();
            strategy.appendField(locator, this, "updatedBy", buffer, theUpdatedBy, (this.updatedBy!= null));
        }
        {
            String theSchemaVersion;
            theSchemaVersion = this.getSchemaVersion();
