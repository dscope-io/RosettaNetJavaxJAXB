...
public class WarrantyProgramType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WarrantyProgramType that = ((WarrantyProgramType) object);
        {
            WarrantyProgramContentType lhsValue;
            lhsValue = this.getValue();
            WarrantyProgramContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            WarrantyProgramContentType theValue;
