...
public class FailureObservedConditionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FailureObservedConditionType that = ((FailureObservedConditionType) object);
        {
            FailureObservedConditionContentType lhsValue;
            lhsValue = this.getValue();
            FailureObservedConditionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FailureObservedConditionContentType theValue;
