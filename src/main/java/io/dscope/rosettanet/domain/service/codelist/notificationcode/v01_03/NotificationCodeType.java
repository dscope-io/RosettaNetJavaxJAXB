...
public class NotificationCodeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NotificationCodeType that = ((NotificationCodeType) object);
        {
            NotificationCodeContentType lhsValue;
            lhsValue = this.getValue();
            NotificationCodeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            NotificationCodeContentType theValue;
