...
public class RepairTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RepairTypeType that = ((RepairTypeType) object);
        {
            RepairTypeContentType lhsValue;
            lhsValue = this.getValue();
            RepairTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RepairTypeContentType theValue;
