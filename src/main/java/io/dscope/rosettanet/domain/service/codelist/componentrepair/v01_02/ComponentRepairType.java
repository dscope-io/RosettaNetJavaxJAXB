...
public class ComponentRepairType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ComponentRepairType that = ((ComponentRepairType) object);
        {
            ComponentRepairContentType lhsValue;
            lhsValue = this.getValue();
            ComponentRepairContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ComponentRepairContentType theValue;
