...
public class ProductReturnReasonType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductReturnReasonType that = ((ProductReturnReasonType) object);
        {
            ProductReturnReasonContentType lhsValue;
            lhsValue = this.getValue();
            ProductReturnReasonContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ProductReturnReasonContentType theValue;
