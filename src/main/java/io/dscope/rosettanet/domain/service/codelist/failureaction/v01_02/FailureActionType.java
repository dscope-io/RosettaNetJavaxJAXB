...
public class FailureActionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FailureActionType that = ((FailureActionType) object);
        {
            FailureActionContentType lhsValue;
            lhsValue = this.getValue();
            FailureActionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FailureActionContentType theValue;
