...
public class ReturnProductInstructionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReturnProductInstructionType that = ((ReturnProductInstructionType) object);
        {
            ReturnProductInstructionContentType lhsValue;
            lhsValue = this.getValue();
            ReturnProductInstructionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ReturnProductInstructionContentType theValue;
