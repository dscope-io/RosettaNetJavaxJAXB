...
public class ClaimStatusType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ClaimStatusType that = ((ClaimStatusType) object);
        {
            ClaimStatusContentType lhsValue;
            lhsValue = this.getValue();
            ClaimStatusContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ClaimStatusContentType theValue;
