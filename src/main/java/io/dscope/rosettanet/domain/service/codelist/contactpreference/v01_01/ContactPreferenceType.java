...
public class ContactPreferenceType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContactPreferenceType that = ((ContactPreferenceType) object);
        {
            ContactPreferenceContentType lhsValue;
            lhsValue = this.getValue();
            ContactPreferenceContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ContactPreferenceContentType theValue;
