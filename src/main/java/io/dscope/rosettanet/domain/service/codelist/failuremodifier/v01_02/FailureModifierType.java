...
public class FailureModifierType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FailureModifierType that = ((FailureModifierType) object);
        {
            FailureModifierContentType lhsValue;
            lhsValue = this.getValue();
            FailureModifierContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            FailureModifierContentType theValue;
