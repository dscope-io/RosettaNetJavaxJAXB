...
public class ServiceDeliveryMethodType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ServiceDeliveryMethodType that = ((ServiceDeliveryMethodType) object);
        {
            ServiceDeliveryMethodContentType lhsValue;
            lhsValue = this.getValue();
            ServiceDeliveryMethodContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            ServiceDeliveryMethodContentType theValue;
