...
public class QualityDispositionType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QualityDispositionType that = ((QualityDispositionType) object);
        {
            QualityDispositionContentType lhsValue;
            lhsValue = this.getValue();
            QualityDispositionContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            QualityDispositionContentType theValue;
