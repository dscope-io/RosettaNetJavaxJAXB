...
public class TPIRFileTypeType implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TPIRFileTypeType that = ((TPIRFileTypeType) object);
        {
            TPIRFileTypeContentType lhsValue;
            lhsValue = this.getValue();
            TPIRFileTypeContentType rhsValue;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            TPIRFileTypeContentType theValue;
