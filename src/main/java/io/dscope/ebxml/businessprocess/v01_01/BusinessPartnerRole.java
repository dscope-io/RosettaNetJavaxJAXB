...
public class BusinessPartnerRole implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BusinessPartnerRole that = ((BusinessPartnerRole) object);
        {
        ...
        {
            List<Performs> lhsPerforms;
            lhsPerforms = (((this.performs!= null)&&(!this.performs.isEmpty()))?this.getPerforms():null);
            List<Performs> rhsPerforms;
            rhsPerforms = (((that.performs!= null)&&(!that.performs.isEmpty()))?that.getPerforms():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "performs", lhsPerforms), LocatorUtils.property(thatLocator, "performs", rhsPerforms), lhsPerforms, rhsPerforms, ((this.performs!= null)&&(!this.performs.isEmpty())), ((that.performs!= null)&&(!that.performs.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Performs> thePerforms;
            thePerforms = (((this.performs!= null)&&(!this.performs.isEmpty()))?this.getPerforms():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "performs", thePerforms), currentHashCode, thePerforms, ((this.performs!= null)&&(!this.performs.isEmpty())));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<Performs> thePerforms;
            thePerforms = (((this.performs!= null)&&(!this.performs.isEmpty()))?this.getPerforms():null);
            strategy.appendField(locator, this, "performs", buffer, thePerforms, ((this.performs!= null)&&(!this.performs.isEmpty())));
        }
        {
            List<Transition> theTransition;
            theTransition = (((this.transition!= null)&&(!this.transition.isEmpty()))?this.getTransition():null);
