...
public class ConditionExpression implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConditionExpression that = ((ConditionExpression) object);
        {
        ...
        {
            String lhsExpressionLanguage;
            lhsExpressionLanguage = this.getExpressionLanguage();
            String rhsExpressionLanguage;
            rhsExpressionLanguage = that.getExpressionLanguage();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "expressionLanguage", lhsExpressionLanguage), LocatorUtils.property(thatLocator, "expressionLanguage", rhsExpressionLanguage), lhsExpressionLanguage, rhsExpressionLanguage, (this.expressionLanguage!= null), (that.expressionLanguage!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theExpressionLanguage;
            theExpressionLanguage = this.getExpressionLanguage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "expressionLanguage", theExpressionLanguage), currentHashCode, theExpressionLanguage, (this.expressionLanguage!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theExpressionLanguage;
            theExpressionLanguage = this.getExpressionLanguage();
            strategy.appendField(locator, this, "expressionLanguage", buffer, theExpressionLanguage, (this.expressionLanguage!= null));
        }
        {
            String theExpression;
            theExpression = this.getExpression();
