...
public class Transition implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            boolean lhsOnInitiation;
            lhsOnInitiation = ((this.onInitiation!= null)?this.isOnInitiation():false);
            boolean rhsOnInitiation;
            rhsOnInitiation = ((that.onInitiation!= null)?that.isOnInitiation():false);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "onInitiation", lhsOnInitiation), LocatorUtils.property(thatLocator, "onInitiation", rhsOnInitiation), lhsOnInitiation, rhsOnInitiation, (this.onInitiation!= null), (that.onInitiation!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            boolean theOnInitiation;
            theOnInitiation = ((this.onInitiation!= null)?this.isOnInitiation():false);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "onInitiation", theOnInitiation), currentHashCode, theOnInitiation, (this.onInitiation!= null));
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            boolean theOnInitiation;
            theOnInitiation = ((this.onInitiation!= null)?this.isOnInitiation():false);
            strategy.appendField(locator, this, "onInitiation", buffer, theOnInitiation, (this.onInitiation!= null));
        }
        {
            String theFromBusinessState;
            theFromBusinessState = this.getFromBusinessState();
