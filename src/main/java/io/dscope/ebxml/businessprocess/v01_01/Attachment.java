...
public class Attachment implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "specification", theSpecification), currentHashCode, theSpecification, (this.specification!= null));
        }
        {
            String theMimeType;
