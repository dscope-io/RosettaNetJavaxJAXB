...
public class Performs implements Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final Performs that = ((Performs) object);
        {
        ...
        {
            String lhsRoleIDREF;
            lhsRoleIDREF = this.getRoleIDREF();
            String rhsRoleIDREF;
            rhsRoleIDREF = that.getRoleIDREF();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "roleIDREF", lhsRoleIDREF), LocatorUtils.property(thatLocator, "roleIDREF", rhsRoleIDREF), lhsRoleIDREF, rhsRoleIDREF, (this.roleIDREF!= null), (that.roleIDREF!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theRoleIDREF;
            theRoleIDREF = this.getRoleIDREF();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "roleIDREF", theRoleIDREF), currentHashCode, theRoleIDREF, (this.roleIDREF!= null));
        }
        {
            String theName;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theRoleIDREF;
            theRoleIDREF = this.getRoleIDREF();
            strategy.appendField(locator, this, "roleIDREF", buffer, theRoleIDREF, (this.roleIDREF!= null));
        }
        {
            String theName;
            theName = this.getName();
